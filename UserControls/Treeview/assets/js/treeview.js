...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        var cssBackgroundImage = this.Appearance.ImageIcon 
                                    ? 'background:url(' + this.Appearance.ImageIcon + ') no-repeat;'
                                    : "";
        ...
        */
        ...
        sb[sb.length] = ' style="' + cssBackgroundImage + 'padding-left: ' + padding + ';"';  //manage custom icon
