...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="GxControl">
    <xsl:choose>
      <xsl:when test="@type = 'DropDownTabsMenu'">
        <xsl:call-template name="RenderDropDownTabsMenu"/>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  <!-- DropDownTabsMenu design render -->
  <!-- ///////////////////  Implement your render here  ///////////////////-->
  <xsl:template name="RenderDropDownTabsMenu">
