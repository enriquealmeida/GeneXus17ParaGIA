 ...
 */
	...
	$.jstree.defaults.core = {
		 ...
		 */
		multiple		: false, // hack to solve issue https://issues.genexus.com/viewissue.aspx?73865
		/**
 ...
 */
	...
	$.jstree.plugins.state = function (options, parent) {
		...
		this.save_state = function () {
			...
			st.state.core.selected = []; // hack to solve issue https://issues.genexus.com/viewissue.aspx?73865
