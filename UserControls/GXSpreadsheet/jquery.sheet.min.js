...
var jS = jQuery.sheet = {
    ...
    sheetSyncSize: function() {
        ...
        /*Start GX Changes */
        //var w = jS.s.width;
        var w = gxSpreadsheetUC.Width;
        if (gxSpreadsheetUC.Width.indexOf("%") == -1)
            w = parseInt(gxSpreadsheetUC.Width) - 20;
        
        if ((gx.util.browser.isFirefox() || gx.util.browser.isChrome()) && jS.s.editable) {
						
           h -= (gxSpreadsheetUC.Menus.length + 1) * 25;
        }
        /*End GX Changes */
