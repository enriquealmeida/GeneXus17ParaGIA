...
import { r as registerInstance, h, g as getElement } from './index-4449a5b3.js';
...
var StaticProvider = /** @class */ (function () {
    function StaticProvider(monaco, configuration, editor, dynamicProvider) {
    ...
    StaticProvider.prototype.getBaseSuggestions = function () {
    ...
    StaticProvider.prototype.getImportSuggestions = function () {
    ...
    StaticProvider.prototype.getAllTokenGroupsSugestions = function (hasDollar, removeMedia) {
        var _this = this;
        ...
        if (this.allTokenGroupsSugestions === null) {
            ...
            tokenGroups.forEach(function (group) {
                if (!(removeMedia && group === "mediaQueries")) {
                    ...
                    var item = {
                        label: '$' + group,
                        kind: _this.monaco.languages.CompletionItemKind.Class,
                        insertText: insertText,
                        command: _this.editor._actions["editor.action.triggerSuggest"]
                    };
    ...
    StaticProvider.prototype.getStarterSuggestion = function () {
    ...
    StaticProvider.prototype.getCssPropertyValues = function (propName) {
        var _this = this;
        console.log("getCssPropertyValues");
        var property = null;
        CSSData.properties.some(function (prop) {
        ...
        if (property != null) {
            if (!this.cssPropertyValues[property.name]) {
                if (property.values != null) {
                    property.values.forEach(function (propValue) {
                        var relevance = propValue.name;
                        if (!propValue.name.startsWith('-'))
                            relevance = "$" + relevance;
                        var item = {
                            label: propValue.name,
                            kind: _this.monaco.languages.CompletionItemKind.Field,
    ...
    StaticProvider.prototype.getGxPropertyValues = function (propName) {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions, property, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        suggestions = [];
                        property = null;
                        if (!(this.allGXProperties === null)) return [3 /*break*/, 2];
                        _b = this;
                        return [4 /*yield*/, this.configuration.handlers.getGxProperties()];
                    case 1:
                        _b.allGXProperties = _c.sent();
                        _c.label = 2;
                    case 2:
                        this.allGXProperties.some(function (prop) {
                            if (prop.Name == propName) {
                                property = prop;
                                return true;
                            }
                        });
                        if (!(property != null)) return [3 /*break*/, 6];
                        if (!property.IsClassRef) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.dynamicProvider.getAllClasses()];
                    case 3:
                        suggestions = _c.sent();
                        return [3 /*break*/, 5];
                    case 4:
                    ...
                    case 6: return [4 /*yield*/, this.dynamicProvider.getAllClasses()];
                    case 7:
                        suggestions = _c.sent();
                        _c.label = 8;
                    case 8:
    ...
    StaticProvider.prototype.getAllCSSPredefinedProperties = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _b, suggestions;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(this.allGXPropertiesSuggestions === null)) return [3 /*break*/, 3];
                        if (!this.configuration.handlers.getGxProperties) return [3 /*break*/, 3];
                        if (!(this.allGXProperties === null)) return [3 /*break*/, 2];
                        _b = this;
                        return [4 /*yield*/, this.configuration.handlers.getGxProperties()];
                    case 1:
                    ...
                    case 2:
                        suggestions = [];
                        this.allGXProperties.forEach(function (property) {
                            var customPropertyId = property.Id;
                            var description = property.Description;
                            var kind = _this.monaco.languages.CompletionItemKind.Method;
                            var appliesTo = "Both";
                            ...
                            if (property.TypesSupport.includes("Smartdevice")) {
                                ...
                                kind = _this.monaco.languages.CompletionItemKind.Function;
                            ...
                            if (property.TypesSupport.includes("Web")) {
                                if (appliesTo === "Smartdevice") {
                                    ...
                                    kind = _this.monaco.languages.CompletionItemKind.Interface;
                                    appliesTo = "Web";
                                }
                            }
                            ...
                            var item = {
                                ...
                                insertText: insertText,
                                insertTextRules: _this.monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                                sortText: sortText,
                                command: _this.editor._actions["editor.action.triggerSuggest"]
                            };
                            suggestions.push(item);
                        ...
                        _c.label = 3;
                    case 3: return [2 /*return*/, this.allGXPropertiesSuggestions];
                }
            });
        });
    };
    StaticProvider.prototype.getAllCSSProperties = function () {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions, predefinedSelectors;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.allCSSProperties === null)) return [3 /*break*/, 2];
                        suggestions = [];
                        CSSData.properties.forEach(function (prop) {
                            var relevance = 99 - prop.relevance;
                            var strRelevance = relevance.toString();
                            if (relevance < 10)
                        ...
                        return [4 /*yield*/, this.getAllCSSPredefinedProperties()];
                    case 1:
                        predefinedSelectors = _b.sent();
                        if (predefinedSelectors != null)
                            suggestions = suggestions.concat(predefinedSelectors);
                        this.allCSSProperties = suggestions;
                        _b.label = 2;
                    case 2: return [2 /*return*/, this.allCSSProperties];
                }
            });
        });
    };
    StaticProvider.prototype.getMediaSuggestion = function (hasDollar) {
...
var DynamicProvider = /** @class */ (function () {
    function DynamicProvider(monaco, configuration) {
        this.monaco = monaco;
        this.configuration = configuration;
    }
    DynamicProvider.prototype.getAllClasses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var classes, suggestions;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.configuration.handlers.getClasses()];
                    case 1:
                        classes = _b.sent();
                        suggestions = [];
    ...
    DynamicProvider.prototype.getAllImages = function () {
        return __awaiter(this, void 0, void 0, function () {
            var images, suggestions;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.configuration.handlers.getImages) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.configuration.handlers.getImages()];
                    case 1:
                        images = _b.sent();
                        suggestions = [];
    ...
    DynamicProvider.prototype.getAllFiles = function () {
        return __awaiter(this, void 0, void 0, function () {
            var files, suggestions;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.configuration.handlers.getFiles) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.configuration.handlers.getFiles()];
                    case 1:
                        files = _b.sent();
                        suggestions = [];
    ...
    DynamicProvider.prototype.getAllDSOs = function () {
        return __awaiter(this, void 0, void 0, function () {
            var files, suggestions;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.configuration.handlers.getAllDSOs) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.configuration.handlers.getAllDSOs()];
                    case 1:
                        files = _b.sent();
                        suggestions = [];
                        files.forEach(function (dsoName) {
                            var item = {
                                label: dsoName,
                                kind: _this.monaco.languages.CompletionItemKind.Class,
                                insertText: dsoName
    ...
    DynamicProvider.prototype.getAllTokensFromGroup = function (group) {
        return __awaiter(this, void 0, void 0, function () {
            var tokens, suggestions;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.configuration.handlers.getTokens != null)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.configuration.handlers.getTokens(group)];
                    case 1:
                        tokens = _b.sent();
                        suggestions = [];
                        if (tokens !== null) {
                            tokens.forEach(function (token) {
                                ...
                                var item = {
                                    label: token,
                                    kind: _this.monaco.languages.CompletionItemKind.Value,
                                    insertText: insertText
                                };
                                suggestions.push(item);
                            });
...
var DSOCompletionItemProvider = /** @class */ (function () {
    function DSOCompletionItemProvider(monaco, getEditor, configuration) {
        var _this = this;
        this.getCompletionItemProvider = function () {
            var dynamicProvider = new DynamicProvider(_this.monaco, _this.configuration);
            var monaco = _this.monaco;
            var configuration = _this.configuration;
            var getEditor = _this.getEditor;
            var calculateSuggestions = _this._calculateSuggestions;
            return {
                provideCompletionItems: function (model, position) {
                    return __awaiter(this, void 0, void 0, function () {
                        var editor, staticProvider, storageService, textUntilPosition, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, getEditor()];
                                case 1:
                                    editor = _c.sent();
                                    staticProvider = new StaticProvider(monaco, configuration, editor, dynamicProvider);
                                    storageService = editor.getContribution("editor.contrib.suggestController").widget._value._storageService;
                                    if (storageService)
                                        storageService.store('expandSuggestionDocs', true, 0);
                                    textUntilPosition = model.getValueInRange({ startLineNumber: 1, startColumn: 1, endLineNumber: position.lineNumber, endColumn: position.column });
                                    _b = {};
                                    return [4 /*yield*/, calculateSuggestions(false, textUntilPosition, dynamicProvider, staticProvider)];
                                case 2: return [2 /*return*/, (_b.suggestions = _c.sent(), _b)];
                            }
                        });
                    });
                },
    ...
    DSOCompletionItemProvider.prototype.caluclateSuggestionsTest = function (completeText) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._calculateSuggestions(true, completeText, null, null)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
    };
    DSOCompletionItemProvider.prototype.checkIfTest = function (isTest, location) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                if (isTest)
    ...
    DSOCompletionItemProvider.prototype._calculateSuggestions = function (isTest, completeText, dynamicProvider, staticProvider) {
        return __awaiter(this, void 0, void 0, function () {
            var text, regexInGxImage, regexInGxFile, regexInInclude, regexInMedia, regexInMediaQueryValue, regexInImport, regexInPropValueFunction, regexInPropValueTokenGroup, regexInPropValue, regexInClass, regexInStart, regexInEmpty, suggestions, _b, _c, res, res, hasDollar, res, res, suggestions, _d, _e, _f, _g, res;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        text = CompletionUtils.removeIrrelevantText(completeText);
                        regexInGxImage = RegExp("gx-image\\(\\s*$");
                        regexInGxFile = RegExp("gx-file\\(\\s*$");
                        regexInInclude = RegExp("@include[^;]*$");
                        regexInMedia = RegExp("@media\\s*(?<dollar>\\$?)*$");
                        regexInMediaQueryValue = RegExp("@media\\s*\\$mediaQueries\\.$");
                        regexInImport = RegExp("@import[^;]*$");
                        regexInPropValueFunction = RegExp("\\s*.*:\\s*.*\\(.*?(?<dollar>\\$?)*$");
                        regexInPropValueTokenGroup = RegExp("\\s*.*:\\s*.*?(\\$(?<group>[^\n\\s]*)\\..*)$");
                        regexInPropValue = RegExp("\\s*(?<propName>[^\n\\s]*):\\s*.*?(?<dollar>\\$)?[^\\.\n\\s]*$");
                        regexInClass = RegExp(".+\\s*{[^}]*$");
                        regexInStart = RegExp("^\\s*$");
                        regexInEmpty = RegExp("^\\s*{");
                        if (!regexInGxFile.test(text)) return [3 /*break*/, 1];
                        if (isTest)
                            return [2 /*return*/, "regexInGxFile"];
                        return [2 /*return*/, dynamicProvider.getAllFiles()];
                    case 1:
                        if (!regexInImport.test(text)) return [3 /*break*/, 3];
                        if (isTest)
                            return [2 /*return*/, "regexInImport"];
                        suggestions = [];
                        suggestions = suggestions.concat(staticProvider.getImportSuggestions());
                        _c = (_b = suggestions).concat;
                        return [4 /*yield*/, dynamicProvider.getAllDSOs()];
                    case 2:
                        suggestions = _c.apply(_b, [_h.sent()]);
                        return [2 /*return*/, suggestions];
                    case 3:
                        if (!regexInGxImage.test(text)) return [3 /*break*/, 4];
                        if (isTest)
                            return [2 /*return*/, "regexInGxImage"];
                        return [2 /*return*/, dynamicProvider.getAllImages()];
                    case 4:
                        if (!regexInInclude.test(text)) return [3 /*break*/, 5];
                        if (isTest)
                            return [2 /*return*/, "regexInInclude"];
                        return [2 /*return*/, dynamicProvider.getAllClasses()];
                    case 5:
                        if (!regexInPropValueFunction.test(text)) return [3 /*break*/, 6];
                        if (isTest)
                            return [2 /*return*/, "regexInPropValueFunction"];
                        if (regexInPropValueTokenGroup.test(text)) {
                            res = text.match(regexInPropValueTokenGroup);
                            return [2 /*return*/, dynamicProvider.getAllTokensFromGroup(res.groups["group"])];
                        }
                        else {
                            res = text.match(regexInPropValueFunction);
                            hasDollar = false;
                            if (res.groups["dollar"] != null)
                                hasDollar = true;
                            return [2 /*return*/, staticProvider.getAllTokenGroupsSugestions(hasDollar, false)];
                        }
                        return [3 /*break*/, 14];
                    case 6:
                        if (!regexInPropValueTokenGroup.test(text)) return [3 /*break*/, 7];
                        if (isTest)
                            return [2 /*return*/, "regexInPropValueTokenGroup"];
                        res = text.match(regexInPropValueTokenGroup);
                        return [2 /*return*/, dynamicProvider.getAllTokensFromGroup(res.groups["group"])];
                    case 7:
                        if (!regexInPropValue.test(text)) return [3 /*break*/, 13];
                        if (isTest)
                            return [2 /*return*/, "regexInPropValue"];
                        res = text.match(regexInPropValue);
                        suggestions = [];
                        if (!(res.groups["dollar"] != null)) return [3 /*break*/, 8];
                        suggestions = suggestions.concat(staticProvider.getAllTokenGroupsSugestions(true, true));
                        return [3 /*break*/, 12];
                    case 8:
                        if (!res.groups["propName"].startsWith("gx-")) return [3 /*break*/, 10];
                        _e = (_d = suggestions).concat;
                        return [4 /*yield*/, staticProvider.getGxPropertyValues(res.groups["propName"])];
                    case 9:
                        suggestions = _e.apply(_d, [_h.sent()]);
                        return [3 /*break*/, 12];
                    case 10:
                        _g = (_f = suggestions).concat;
                        return [4 /*yield*/, staticProvider.getCssPropertyValues(res.groups["propName"])];
                    case 11:
                        suggestions = _g.apply(_f, [_h.sent()]);
                        _h.label = 12;
                    case 12: return [2 /*return*/, suggestions];
                    case 13:
                        if (regexInClass.test(text)) {
                            if (isTest)
                                return [2 /*return*/, "regexInClass"];
                            return [2 /*return*/, staticProvider.getAllCSSProperties()];
                        }
                        else if (regexInMedia.test(text)) {
                            if (isTest)
                                return [2 /*return*/, "regexInMedia"];
                            res = text.match(regexInMedia);
                            return [2 /*return*/, staticProvider.getMediaSuggestion(res.groups["dollar"] != null)];
                        }
                        else if (regexInMediaQueryValue.test(text)) {
                            if (isTest)
                                return [2 /*return*/, "regexInMediaQueryValue"];
                            return [2 /*return*/, dynamicProvider.getAllTokensFromGroup("mediaQueries")];
                        }
                        else if (regexInEmpty.test(text)) {
                            if (isTest)
                                return [2 /*return*/, "regexInEmpty"];
                            return [2 /*return*/, staticProvider.getBaseSuggestions()];
                        }
                        else if (regexInStart.test(text)) {
                            if (isTest)
                                return [2 /*return*/, "regexInStart"];
                            return [2 /*return*/, staticProvider.getStarterSuggestion()];
                        }
                        else {
                            if (isTest)
                                return [2 /*return*/, "noMatch"];
                            return [2 /*return*/, staticProvider.getBaseSuggestions()];
                        }
                        _h.label = 14;
    ...
    return DSOCompletionItemProvider;
}());
var CompletionUtils = /** @class */ (function () {
    function CompletionUtils() {
    }
    CompletionUtils.removeIrrelevantText = function (text) {
        var cleanText = text;
...
var IconHelper = /** @class */ (function () {
    ...
    IconHelper.getIconFromGxName = function (name) {
        var geminiIcon = IconHelper.IconsMapping[name];
        if (geminiIcon == null)
...
var ElementFinder = /** @class */ (function () {
    ...
    ElementFinder.closeElement = function (baseElement, tagName, id) {
        var candidates = baseElement.getElementsByTagName(tagName);
...
var WidgetHelper = /** @class */ (function () {
    function WidgetHelper() {
    }
    WidgetHelper.closeReferencesWidget = function (editor) {
...
var DSOCodeLensesProvider = /** @class */ (function () {
    function DSOCodeLensesProvider(monaco, editor, configuration, language) {
        this.monaco = monaco;
        this.editor = editor;
        this.configuration = configuration;
        this.language = language;
    }
    DSOCodeLensesProvider.prototype.getCodeLensProvider = function (commandId) {
        var configuration = this.configuration;
        return {
            provideCodeLenses: function (model, token) {
                return __awaiter(this, void 0, void 0, function () {
                    var lenses, position, classReferences, lines;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                console.log(token);
                                lenses = [];
                                position = 0;
                                return [4 /*yield*/, configuration.handlers.getReferences()];
                            case 1:
                                classReferences = _b.sent();
                                lines = model.getLinesContent();
                                lines.forEach(function (lineValue, index) {
                                    var line = lineValue.trim();
                                    if (DSOCodeLensesConstants.CLASS_REGEX.test(line)) {
                                        var res = line.match(DSOCodeLensesConstants.CLASS_REGEX);
                                        var references = null;
    ...
    DSOCodeLensesProvider.prototype.getCodeLensCommand = function () {
        ...
        return function (ctx, parms) {
            ...
            var contentWidget = {
                ...
                getDomNode: function () {
                    var id = editor.getId() + DSOCodeLensesIDs.REFERENCES_POPUP_ID;
                    WidgetHelper.closeReferencesWidget(editor);
                    var filter = document.createElement(DSOCodeLensesGemini.GXG_FILTER);
                    filter.id = id;
                    parms[DSOCodeLensesConstants.REFS].forEach(function (ref) {
                        var filterItem1 = document.createElement(DSOCodeLensesGemini.GXG_FILTER_ITEM);
                    ...
                    filter.addEventListener(DSOCodeLensesGemini.ITEM_CLICKED_EVENT, function (info) {
    ...
    return DSOCodeLensesProvider;
}());
var DSOCodeLensesConstants = /** @class */ (function () {
    function DSOCodeLensesConstants() {
    }
    return DSOCodeLensesConstants;
}());
...
var DSOCodeLensesIDs = /** @class */ (function () {
    function DSOCodeLensesIDs() {
    }
    return DSOCodeLensesIDs;
}());
DSOCodeLensesIDs.MY_CONTENT_WIDGET_ID = "my.content.widget";
DSOCodeLensesIDs.REFERENCES_POPUP_ID = "ReferencesPopup";
var DSOCodeLensesGemini = /** @class */ (function () {
    function DSOCodeLensesGemini() {
    }
    return DSOCodeLensesGemini;
}());
...
var InitializationHelper = /** @class */ (function () {
    ...
    InitializationHelper.afterInitialize = function (editor) {
        if (editor) {
...
var geminiCss = "@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700;800&display=swap\"); :root{--ui-animaton-speed:0.2s}.gxg-title-01{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em}.gxg-title-01--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-title-02{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em}.gxg-title-02--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em;color:var(--color-on-primary)}.gxg-title-03{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-xs);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em}.gxg-title-03--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-xs);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em;color:var(--color-on-primary)}.gxg-title-04{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em}.gxg-title-04--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-title-05{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;line-height:1.556em}.gxg-title-05--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;line-height:1.556em;color:var(--color-on-primary)}.gxg-text{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em}.gxg-text--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-text--gray{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--gray-05)}.gxg-quote{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;font-style:italic}.gxg-quote--negative{color:var(--color-on-primary)}.gxg-link{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-primary);text-decoration:underline;cursor:pointer;display:inline-block}.gxg-link:hover{color:var(--color-primary-hover)}.gxg-link:active{color:var(--color-primary-active)}.gxg-link-gray{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-primary);text-decoration:underline;cursor:pointer;display:inline-block;color:var(--gray-04)}.gxg-link-gray:hover{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-primary);text-decoration:underline;cursor:pointer;display:inline-block;color:var(--gray-04);color:var(--gray-06)}.gxg-alert-error{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-error-dark);display:inline-block}.gxg-alert-warning{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-warning-dark);display:inline-block}.gxg-alert-success{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-success-dark);display:inline-block}.gxg-tab--disabled{color:var(--color-primary-disabled);pointer-events:none}.gxg-tab--disabled[disabled]{color:var(--color-primary-disabled);pointer-events:none}.gxg-label{font-family:var(--font-family-primary) !important;font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm) !important;letter-spacing:var(--letter-spacing-xs);color:var(--color-primary-enabled);text-align:center;line-height:1.455em}.gxg-label:hover{color:var(--color-primary-hover)}.gxg-label:focud{color:var(--color-primary-active)}.gxg-label:active{color:var(--color-primary-active)}.gxg-label[disabled]{color:var(--color-primary-disabled)}.gxg-label--negative{color:var(--color-on-primary)}.gxg-label--negative[disabled]{color:var(--color-on-disabled)}.gxg-button-styles{font-family:var(--font-family-primary) !important;font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm) !important;letter-spacing:var(--letter-spacing-xs);color:var(--color-primary-enabled);text-align:center;line-height:1.455em}:root{--border-width-sm:1px;--border-width-md:2px;--border-width-lg:4px;--border-style-regular:solid;--border-radius-xs:1px;--border-radius-sm:2px;--border-radius-md:3px;--border-radius-lg:8px;--box-shadow-values:inset 0px 0px 0px 2px}:root{--color-primary-enabled:#0266a0;--color-primary-active:#005688;--color-primary-hover:#0077de;--color-primary-disabled:#828385}:root.dark{--color-primary-enabled:#91c8e4;--color-primary-active:#4ba3d4;--color-primary-hover:#8dcbff;--color-primary-disabled:#828385}:root{--color-secondary-enabled:#cfdee6;--color-secondary-active:#6a8c9f;--color-secondary-hover:#97b0bf;--color-secondary-disabled:#828385}:root.dark{--color-secondary-enabled:#5d7c8d;--color-secondary-active:#3f5460;--color-secondary-hover:#4d6776;--color-secondary-disabled:#828385}:root{--color-primary-hover-opacity-01:rgba(0, 119, 222, 0.1)}:root.dark{--color-primary-hover-opacity-01:rgba(141, 203, 255, 0.1)}:root{--color-on-primary:#fff;--color-on-secondary:#000;--color-on-background:#000;--color-on-alert:#000;--color-on-disabled:#a4a5a6;--color-always-black:#000;--color-always-white:#fff}:root.dark{--color-on-primary:#1d1e22;--color-on-secondary:#fff;--color-on-background:#fff;--color-on-alert:#fff;--color-on-disabled:#616164;--color-always-black:#000;--color-always-white:#fff}:root{--color-primary:var(--color-primary-enabled);--color-secondary:var(--color-secondary-enabled)}:root.dark{--color-primary-rgb:var(--color-primary-enabled);--color-secondary:var(--color-secondary-enabled)}:root{--color-background:#fff}:root.dark{--color-background:#1d1e22}:root{--color-error-dark:#f02031;--color-error-light:#ffeaee;--color-warning-dark:#ff8000;--color-warning-light:#ffe7e6;--color-success-dark:#02a08b;--color-success-light:#e1f3f1}:root.dark{--color-error-dark:#f9464e;--color-error-light:#281617;--color-warning-dark:#ffab13;--color-warning-light:#292011;--color-success-dark:#50beae;--color-success-light:#172221}:root{--gray-01:#e8e8e9;--gray-02:#c6c6c7;--gray-03:#a4a5a6;--gray-04:#828385;--gray-05:#616164;--gray-06:#3e3f42;--gray-07:#28292d}:root.dark{--gray-01:#28292d;--gray-02:#3e3f42;--gray-03:#616164;--gray-04:#828385;--gray-05:#a4a5a6;--gray-06:#c6c6c7;--gray-07:#e8e8e9}:root{--icons01-enabled:#0266a0;--icons02-enabled:#605cab;--icons03-enabled:#00746b;--icons04-enabled:#00a99d;--icons05-enabled:#39b54a;--icons06-enabled:#ed145b;--icons07-enabled:#f26522;--icons08-enabled:#f7941d;--icons09-enabled:#616164;--icons01-active:#004a81;--icons02-active:#484099;--icons03-active:#02645b;--icons04-active:#00998c;--icons05-active:#2fa640;--icons06-active:#dc105a;--icons07-active:#e75e1e;--icons08-active:#f3891b;--icons09-active:#3e3f42;--icons01-hover:#2088c2;--icons02-hover:#9e9ecc;--icons03-hover:#009187;--icons04-hover:#7ccdc7;--icons05-hover:#79cc81;--icons06-hover:#f4608d;--icons07-hover:#f59065;--icons08-hover:#fab454;--icons09-hover:#828385;--icons-disabled:#a4a5a6}:root.dark{--icons01-enabled:#4ba3d4;--icons02-enabled:#9e9ecc;--icons03-enabled:#24a19a;--icons04-enabled:#7ccdc7;--icons05-enabled:#a1daa5;--icons06-enabled:#f4608d;--icons07-enabled:#f59065;--icons08-enabled:#fab454;--icons09-enabled:#a4a5a6;--icons01-active:#4497c6;--icons02-active:#7979b8;--icons03-active:#009088;--icons04-active:#45b9b1;--icons05-active:#7bcc81;--icons06-active:#f03d73;--icons07-active:#f37943;--icons08-active:#f9a533;--icons09-active:#c6c6c7;--icons01-hover:#6abee0;--icons02-hover:#c4c4e1;--icons03-hover:#7ec8c5;--icons04-hover:#b0e0dd;--icons05-hover:#c6e8c8;--icons06-hover:#f78ead;--icons07-hover:#facebc;--icons08-hover:#fddfb4;--icons09-hover:#828385;--icons-disabled:#3e3f42}:root{--color-bpm-01:#ff9a1b;--color-bpm-02:#1b82ff;--color-bpm-03:#ffed39;--color-bpm-04:#ff261b;--color-bpm-05:#2dcf76;--color-bpm-start:#87cf2d;--color-bpm-end:#ff261b;--color-bpm-gateways:#2dcf76;--color-bpm-intermediate:#3e3f42}:root.dark{--color-bpm-01:#ffb754;--color-bpm-02:#5bb2ff;--color-bpm-03:#fef69c;--color-bpm-04:#f89491;--color-bpm-05:#96e3b0;--color-bpm-start:#87cf2d;--color-bpm-end:#ff261b;--color-bpm-gateways:#2dcf76;--color-bpm-intermediate:#c6c6c7}:root{--box-shadow-00:none;--box-shadow-01:0px 1px 1px 0px rgba(0, 0, 0, 0.14),\n    0px 2px 1px -1px rgba(0, 0, 0, 0.12), 0px 1px 3px 0px rgba(0, 0, 0, 0.2);--box-shadow-02:0px 2px 2px 0px rgba(0, 0, 0, 0.14),\n    0px 3px 1px -2px rgba(0, 0, 0, 0.12), 0px 1px 5px 0px rgba(0, 0, 0, 0.2);--box-shadow-03:0px 3px 4px 0px rgba(0, 0, 0, 0.14),\n    0px 3px 3px -2px rgba(0, 0, 0, 0.12), 0px 1px 8px 0px rgba(0, 0, 0, 0.2);--box-shadow-04:0px 4px 5px 0px rgba(0, 0, 0, 0.14),\n    0px 1px 10px 0px rgba(0, 0, 0, 0.12), 0px 2px 4px -1px rgba(0, 0, 0, 0.2);--box-shadow-06:0px 6px 10px 0px rgba(0, 0, 0, 0.14),\n    0px 1px 18px 0px rgba(0, 0, 0, 0.12), 0px 3px 5px -1px rgba(0, 0, 0, 0.2);--box-shadow-08:0px 8px 10px 1px rgba(0, 0, 0, 0.14),\n    0px 3px 14px 2px rgba(0, 0, 0, 0.12), 0px 5px 5px -3px rgba(0, 0, 0, 0.2);--box-shadow-09:0px 9px 12px 1px rgba(0, 0, 0, 0.14),\n    0px 3px 16px 2px rgba(0, 0, 0, 0.12), 0px 5px 6px -3px rgba(0, 0, 0, 0.2);--box-shadow-12:0px 12px 17px 2px rgba(0, 0, 0, 0.14),\n    0px 5px 22px 4px rgba(0, 0, 0, 0.12), 0px 7px 8px -4px rgba(0, 0, 0, 0.2)}:root{--font-family-primary:\"Open Sans\", sans-serif;--font-family-secondary:sans-serif;--font-weight-regular:400;--font-weight-semibold:600;--font-weight-bold:700;--font-weight-extra-bold:800;--font-size-xxs:8px;--font-size-xs:9px;--font-size-sm:10px;--font-size-md:11px;--font-size-lg:12px;--font-size-xl:13px;--font-style-regular:normal;--line-height-regular:normal;--letter-spacing-xs:0.2px;--letter-spacing-sm:0.25px;--letter-spacing-md:0.3px;--letter-spacing-lg:0.6px}.gxg-title-01{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em}.gxg-title-01--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-title-02{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em}.gxg-title-02--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-bold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em;color:var(--color-on-primary)}.gxg-title-03{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-xs);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em}.gxg-title-03--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-xs);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;text-transform:uppercase;line-height:1.556em;color:var(--color-on-primary)}.gxg-title-04{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em}.gxg-title-04--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-md);letter-spacing:var(--letter-spacing-md);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-title-05{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;line-height:1.556em}.gxg-title-05--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-sm);color:var(--color-on-background);text-align:start;line-height:1.556em;color:var(--color-on-primary)}.gxg-text{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;cursor:pointer}.gxg-text--negative{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-on-primary)}.gxg-text--gray{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--gray-05)}.gxg-link{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;color:var(--color-primary);text-decoration:underline;cursor:pointer;display:inline-block}.gxg-link:hover{color:var(--color-primary-hover)}.gxg-link:active{color:var(--color-primary-active)}.gxg-quote{font-family:var(--font-family-primary);font-weight:var(--font-weight-regular);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-xs);color:var(--color-on-background);text-align:start;line-height:1.455em;font-style:italic}.gxg-quote--negative{color:var(--color-on-primary)}.gxg-tab{font-family:var(--font-family-primary);font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm);letter-spacing:var(--letter-spacing-lg);color:var(--color-on-background);text-align:center;text-transform:uppercase;line-height:1.778em}.gxg-tab:active{font-weight:var(--font-weight-bold)}.gxg-tab--active{font-weight:var(--font-weight-bold)}.gxg-tab--disabled{color:var(--color-primary-disabled);pointer-events:none}.gxg-label{font-family:var(--font-family-primary) !important;font-weight:var(--font-weight-semibold);font-size:var(--font-size-sm) !important;letter-spacing:var(--letter-spacing-xs);color:var(--color-primary-enabled);text-align:center;line-height:1.455em}.gxg-label--disabled{color:var(--color-primary-disabled)}.gxg-label:not(.gxg-label--negative):not(.gxg-label--negative-disabled):not(.gxg-label--disabled):hover{color:var(--color-primary-hover)}.gxg-label:not(.gxg-label--negative):not(.gxg-label--negative-disabled):not(.gxg-label--disabled):focus{color:var(--color-primary-active)}.gxg-label:not(.gxg-label--negative):not(.gxg-label--negative-disabled):not(.gxg-label--disabled):active{color:var(--color-primary-active)}.gxg-label--negative{color:var(--color-on-primary)}.gxg-label--negative-disabled{color:var(--color-on-disabled)}:root{--outline-width-regular:2px;--outline-style-regular:solid}:root{--spacing-comp-01:4px;--spacing-comp-02:8px;--spacing-comp-03:12px;--spacing-comp-04:16px;--spacing-comp-05:24px;--spacing-comp-06:32px;--spacing-comp-07:40px;--spacing-comp-08:50px;--spacing-comp-09:60px}:root{--spacing-lay-xs:4px;--spacing-lay-s:8px;--spacing-lay-m:16px;--spacing-lay-l:32px;--spacing-lay-xl:64px}:root{--timing-01:200;--timing-02:500;--timing-03:1000;--timing-04:2000;--timing-05:3500;--timing-06:5000;--timing-07:7000;--timing-08:9000;--timing-09:12000;--timing-10:15000}";
var dsoStylesEditorScss = geminiCss + ".ref-box{background:white;padding:5px;border:1px solid grey;min-width:185px;max-height:120px}.ref-close-button{background:white;border:none;font-size:16px;font-weight:bold}.ref-row{display:block;font-size:12px}.ref-row:hover{background-color:#9fc3ff}";
var DSOStylesEditor = /** @class */ (function () {
    ...
    class_1.prototype.getTextEditor = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.element.querySelector('gx-text-editor')];
            });
        });
    };
    class_1.prototype.editorValueChangedListener = function () {
    ...
    class_1.prototype._getValue = function () {
        if (this.value)
            return this.value;
        return '';
    };
    class_1.prototype._setConfiguration = function () {
        if (this.configuration)
            return this.configuration;
        this.configuration = getEditorConfiguration();
    };
    class_1.prototype._getCompletionItemProvider = function () {
    ...
    class_1.prototype._getEditor = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, ((_a = this.element.querySelector('gx-text-editor')) === null || _a === void 0 ? void 0 : _a.getEditor())];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
    };
    class_1.prototype._getCodeLensProvider = function (editor) {
    ...
    class_1.prototype._getActions = function () {
        return [];
    };
...
DSOStylesEditor.style = dsoStylesEditorScss;
export { DSOStylesEditor as gx_dso_styles_editor };
