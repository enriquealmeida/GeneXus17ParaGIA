    ...
    *********************************/
    ...
    printTitle() {
        if (this.title !== undefined) {
            return index.h("h2", { class: "alert-message--title" }, this.title);
        }
    }
    setAlertInactive() {
        this.active = false;
    ...
    alertHidden() {
        if (this.active) {
            if (!this.silent) {
                let audio;
                if (this.type === "warning") {
                    audio = new Audio(index.getAssetPath("./alert-assets/warning.mp3"));
                }
                else if (this.type === "error") {
                    audio = new Audio(index.getAssetPath("./alert-assets/error.mp3"));
                }
                setTimeout(function () {
                    audio.play();
                }, 100);
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "alert", "aria-hidden": this.alertHidden(), hidden: true, class: { rtl: this.rtl }, style: {
            ...
            } }, index.h("div", { class: "alert-message--container" }, index.h("div", { class: "alert-message--icon" }, index.h("gxg-icon", { color: this.iconColor(), slot: "icon", type: "gemini-tools/" + this.type })), index.h("div", { class: "alert-message-title-description" }, this.printTitle(), index.h("p", { class: "alert-message--description" }, index.h("slot", null)))), index.h("div", { class: "alert-message-close" }, this.type === "notice" ? (index.h("gxg-button", { type: "tertiary", icon: "gemini-tools/close", onClick: this.setAlertInactive.bind(this), negative: true })) : (index.h("gxg-button", { type: "tertiary", icon: "gemini-tools/close", onClick: this.setAlertInactive.bind(this), "always-black": true }))))));
    }
