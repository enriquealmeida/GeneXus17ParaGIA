...
const GxgSlider = class {
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            }, style: { maxWidth: this.maxWidth } }, index.h("div", { class: "container" }, index.h("div", { class: "range-slider" }, index.h("span", { class: "rs-label" }, "0"), index.h("input", { onInput: this.rangeSliderChanged.bind(this), id: "rs-range-line", class: "rs-range", type: "range", min: "0", max: this.max, value: this.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.max, "aria-valuenow": this.value })), index.h("div", { class: "box-value" }, index.h("label", { class: "label" }, this.label), index.h("span", { id: "actual-value" })))));
    }
