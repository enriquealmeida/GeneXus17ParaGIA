        ...
        if (this.initiateDemo === true) {
            return [
                index.h("div", { class: {
                    ...
                    } }, index.h("div", { class: "tooltip__number" }, this.currentItem + 1), index.h("div", { class: "tooltip__message" }, this.message)),
                index.h("div", { class: {
                        modal: true,
                        visible: this.modalVisible,
                    }, style: {
                        zIndex: (this.layerZIndex + 1).toString(),
                    } }, index.h("div", { class: "col-left" }, index.h("p", null, this.modalMessage)), index.h("div", { class: "col-right" }, index.h("gxg-button", { type: "outlined", onClick: this.endDemo.bind(this) }, "End demo"), index.h("gxg-button", { type: "primary-text-only", onClick: this.previousItem.bind(this), disabled: this.currentItem === 0 }, "Previous"), index.h("gxg-button", { type: "primary-text-only", onClick: this.nextItem.bind(this), class: {
                        "next-button": true,
