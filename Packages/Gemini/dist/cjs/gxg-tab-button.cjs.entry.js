...
const GxgTabButton = class {
    ...
    printIcon() {
        if (this.icon !== null) {
            if (this.disabled) {
                return index.h("gxg-icon", { color: "disabled", type: this.icon });
            }
            return index.h("gxg-icon", { type: this.icon });
        }
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h("li", { class: "tab-item" }, index.h("button", { disabled: this.disabled, class: {
                "tab-button": true,
                "tab-button--selected": this.isSelected === true,
                "tab-button--text-icon": this.tabLabel !== null && this.icon !== null,
            }, onClick: this.tabButtonClicked.bind(this) }, this.printIcon(), index.h("span", { class: "tab-button__text" }, this.tabLabel)), index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
GxgTabButton.style = tabButtonCss;

exports.gxg_tab_button = GxgTabButton;
