    ...
    *********************************/
    ...
    render() {
        ...
        if (this.buttonGroupTitle !== undefined) {
            header = (index.h("header", { class: "button-group-header" }, index.h("label", { class: "button-group-header-title" }, this.buttonGroupTitle)));
        }
        return (index.h(index.Host, { tabindex: this.tabIndex(), role: "group", "aria-label": this.buttonGroupTitle, class: {
                "button-group": true,
                rtl: this.rtl,
                large: store.state.large,
            }, value: this.value, "title-alignment": this.titleAlignment, onKeyUp: this.detectFocus.bind(this) }, header, index.h("div", { class: "button-group-container", onClick: this.setActiveButton.bind(this) }, this.disabled ? index.h("div", { class: "disabled-layer" }) : null, index.h("slot", null))));
    }
    get el() { return index.getElement(this); }
};
GxgButtonGroup.style = buttonGroupCss;

exports.gxg_button_group = GxgButtonGroup;
