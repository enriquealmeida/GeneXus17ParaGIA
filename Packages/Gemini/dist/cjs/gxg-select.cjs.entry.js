    ...
    *********************************/
    ...
    render() {
        return (index.h(index.Host, { style: {
            ...
            }, onKeyDown: this.handlerOnKeyDown.bind(this) }, index.h("div", { class: "outer-wrapper" }, this.label !== undefined ? (index.h("label", { class: {
                label: true,
            ...
            }, ref: (el) => (this.select = el) }, index.h("select", { id: "original" }, index.h("slot", null)))), common.formMessage()));
    }
...
exports.gxg_select = GxgFormSelect;
