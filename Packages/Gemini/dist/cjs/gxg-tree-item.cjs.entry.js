...
const GxgTreeItem = class {
    constructor(hostRef) {
        ...
        this.liItemClicked = index.createEvent(this, "liItemClicked", 7);
        this.toggleIconClicked = index.createEvent(this, "toggleIconClicked", 7);
        this.checkboxClickedEvent = index.createEvent(this, "checkboxClickedEvent", 7);
        //PROPS
        /**
    ...
    render() {
        return (index.h(index.Host, { class: { leaf: this.isLeaf, "not-leaf": !this.isLeaf } }, index.h("li", { class: {
            ...
            ? [
                index.h("span", { class: { "vertical-line": true }, style: {
                ...
                index.h("div", { class: { "closed-opened-icons": true } }, index.h("gxg-icon", { type: this.returnToggleIconType(), size: "small", onClick: this.toggleTreeIconClicked.bind(this), class: "toggle-icon" })),
            ]
            : null, index.h("span", { class: {
                "horizontal-line": true,
                "display-none": this.numberOfParentTrees === 1,
            }, style: {
                left: this.itemPaddingLeft + "px",
            } }), this.checkbox ? (index.h("gxg-form-checkbox", { checked: this.checked, class: { checkbox: true }, tabIndex: this.checkboxTabIndex(), indeterminate: this.setIndeterminate(), disabled: this.disabled, onClick: this.checkboxClicked.bind(this) })) : null, this.leftIcon ? (index.h("gxg-icon", { size: "small", type: this.leftIcon, color: this.disabled ? "disabled" : "auto" })) : null, index.h("span", { class: "text" }, index.h("slot", null)), this.rightIcon ? (index.h("gxg-icon", { size: "small", type: this.rightIcon, color: this.rightIconColor, class: { "right-icon": true } })) : null, this.download ? index.h("span", { class: { loading: true } }) : null), index.h("slot", { name: "tree" }))));
    }
