...
const GxgAccordionItem = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.accordionItemClicked = index.createEvent(this, "accordionItemClicked", 7);
        this.accordionItemLoaded = index.createEvent(this, "accordionItemLoaded", 7);
        this.accordionTitleClicked = index.createEvent(this, "accordionTitleClicked", 7);
        this.titleChanged = index.createEvent(this, "titleChanged", 7);
        /**
    ...
    printIcon() {
        ...
        return (index.h("gxg-icon", { slot: "icon", size: "regular", type: iType, color: iColor }));
    }
    componentWillLoad() {
        if (!this.itemId) {
    ...
    render() {
        ...
        index.h("div", { class: {
            ...
            } })) : null, index.h("div", { class: "item__header__button__title-subtitle" }, index.h("h1", { class: "item__header__button__title-subtitle__title", onClick: this.titleClickedHandler.bind(this) }, this.titleIcon !== null &&
            (this.accordionMode === "classical" ||
                this.accordionMode === "boxed") ? (index.h("div", { class: "item__header__button__title-subtitle__title__icon" }, index.h("gxg-icon", { size: "regular", type: this.titleIcon, color: this.disabled ? "ondisabled" : "auto" }))) : null, this.editableTitle &&
            (this.mode === "classical" || this.mode === "boxed") ? (
        //editable title should only be available for "classical" or "boxed" modes
        index.h("gxg-form-text", { onChange: (event) => this.changedTitleHandler(event), minimal: true, "over-dark-background":  this.disabled && this.mode === "classical"
            ...
            this.itemSubtitle !== null ? (index.h("h2", { class: "item__header__button__title-subtitle__subtitle", title: this.itemSubtitleTrimmed(this.itemSubtitle) }, this.itemSubtitle.length > 50
            ? this.itemSubtitle.slice(0, 50) + "..."
            : this.itemSubtitle)) : null), index.h("div", { class: "item__header__button__meta-icon-wrapper" }, this.hasSlottedMeta &&
            (this.mode === "classical" || this.mode === "boxed") ? (index.h("div", { class: "item__header__button__meta-icon-wrapper__meta" }, index.h("slot", { name: "meta" }))) : null, index.h("div", { class: "item__header__button__meta-icon-wrapper__icon" }, this.printIcon())))), this.status === "open" && !this.disabled ? (index.h("main", { class: "item__container", id: this.itemId, role: "region", "aria-labelledby": "accordion-" + this.itemId }, index.h("slot", null))) : (""))));
    }
    get el() { return index.getElement(this); }
};
GxgAccordionItem.style = accordionItemCss;

exports.gxg_accordion_item = GxgAccordionItem;
