...
const GxgCombo = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: { "main-container": true }, style: { width: this.width } }, index.h("div", { class: { "search-container": true } }, index.h("gxg-form-text", { placeholder: "Search item", onInput: this.onInputGxgformText.bind(this), onKeyDown: this.onKeyDownGxgformText.bind(this), onFocus: () => this.onInputFocus(), value: this.selectedItemValue, id: "gxgFormText", icon: this.inputTextIcon, iconPosition: this.inputTextIconPosition, ref: (el) => (this.textInput = el) }), this.inputTextValue !== "" ? (index.h("gxg-button", { class: { "delete-icon": true }, icon: "menus/delete", type: "tertiary", onClick: () => this.clearInputFunc() })) : null, index.h("gxg-button", { class: { "arrow-down-icon": true }, icon: "navigation/arrow-down", type: "tertiary", onClick: () => this.toggleItems() }), index.h("span", { class: "layer" })), this.showItems ? (index.h("div", { class: {
                "items-container": true,
            } }, index.h("slot", null), this.noMatch ? (index.h("div", { class: "no-courrences-found" }, "No occurrences found", index.h("span", null, "ctrl/cmd + backspace to erase"))) : null)) : null)));
    }
    get el() { return index.getElement(this); }
};
GxgCombo.style = comboCss;

exports.gxg_combo = GxgCombo;
