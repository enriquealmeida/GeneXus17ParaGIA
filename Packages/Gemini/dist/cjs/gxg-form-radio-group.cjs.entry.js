...
const GxgFormRadioGroup = class {
    ...
    *********************************/
    ...
    labelFunc() {
        if (this.label) {
            return (index.h("span", { class: "label" }, this.label, common.requiredLabel(this)));
        }
    }
    render() {
        return (index.h(index.Host, null, this.labelFunc(), index.h("slot", null), common.formMessage(this.isRequiredError ? (index.h("gxg-form-message", { type: "error", key: "required-error" }, this.requiredMessage)) : null)));
    }
