...
const GxgTabBar = class {
    ...
    renderTabBarMenu() {
        if (this.appendedButtons > 0) {
            return (index.h("div", { class: "tab-bar__menu" }, index.h("gxg-button", { onClick: this.toggleMenu.bind(this), type: "tertiary", icon: "gemini-tools/show-more-vertical" })));
        }
    }
    ...
    render() {
        return (index.h(index.Host, { class: {
                ...
                nav: true,
            } }, index.h("ul", { class: "tab-bar" }, index.h("slot", { name: "tab-bar" })), this.renderTabBarMenu(), index.h("ul", { class: "tab-bar-menu tab-bar-menu--collapsed", style: { "--tabBarMenuHeight": this.tabBarMenuHeight }, ref: (el) => (this.tabBarMenu = el) }, index.h("slot", { name: "tab-menu" })))));
    }
    get el() { return index.getElement(this); }
};
GxgTabBar.style = tabBarCss;

exports.gxg_tab_bar = GxgTabBar;
