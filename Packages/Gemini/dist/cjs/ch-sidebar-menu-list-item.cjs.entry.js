...
const ChSidebarMenuListItem = class {
    ...
    listItemContent() {
        if (this.listTypeItem === "one")
            return [
                index.h("div", { class: "main-container", onClick: this.itemClicked.bind(this) }, index.h("div", { class: "left-container" }, index.h("span", { class: "icon custom-icon" }, index.h("ch-icon", { src: this.firstListItemIcon(), style: {
                        "--icon-size": "20px",
                        "--icon-color": `var(--first-list-icon-color)`,
                    } })), index.h("span", { class: "text" }, index.h("slot", null))), this.collapsable ? (index.h("span", { class: "icon arrow-icon" }, index.h("ch-icon", { src: this.arrowTop, style: {
                        "--icon-size": "20px",
        ...
        if (this.listTypeItem === "two")
            return [
                index.h("div", { class: "main-container", onClick: this.itemClicked.bind(this) }, this.collapsable ? (index.h("span", { class: "icon arrow-icon" }, index.h("ch-icon", { src: this.arrowRight, style: {
                        "--icon-size": "20px",
                        "--icon-color": `var(--second-list-arrow-color)`,
                    } }))) : null, index.h("span", { class: "text" }, index.h("slot", null))),
                index.h("slot", { name: "list" }),
            ];
        if (this.listTypeItem === "three")
            return (index.h("div", { class: "main-container", onClick: this.itemClicked.bind(this) }, index.h("span", { class: "text" }, index.h("slot", null))));
    }
    render() {
    ...
    static get assetsDirs() { return ["sidebar-menu-list-item-assets"]; }
    get el() { return index.getElement(this); }
};
ChSidebarMenuListItem.style = chSidebarMenuListItemCss;

exports.ch_sidebar_menu_list_item = ChSidebarMenuListItem;
