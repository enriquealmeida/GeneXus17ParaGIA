...
const GxgDropDown = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: { "main-container": true }, style: { width: this.width } }, this.label !== "" ? (index.h("label", { class: { label: true } }, this.label)) : null, index.h("div", { class: {
                "select-container": true,
                "nothing-selected": this.initialButtonText === "Select item",
                focus: this.showContent,
            }, onClick: () => this.toggleContent() }, this.icon !== "" ? (index.h("gxg-icon", { class: "icon", type: this.icon, color: "auto", size: "small" })) : null, this.initialButtonText !== "" ? this.initialButtonText : null, index.h("slot", { name: "button" }), index.h("span", { class: "layer" })), this.showContent ? (index.h("div", { class: {
                "content-container": true,
            }, style: {
                maxHeight: this.maxHeight,
            } }, index.h("slot", null))) : null)));
    }
...
exports.gxg_drop_down = GxgDropDown;
