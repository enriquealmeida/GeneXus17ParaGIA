...
const GxgText = class {
    ...
    textType() {
        ...
        switch (this.type) {
            case "text-regular":
                text = index.h("p", { class: "gxg-text" }, index.h("slot", null));
                break;
            case "text-gray":
                text = index.h("p", { class: "gxg-text--gray" }, index.h("slot", null));
                break;
            case "text-quote":
                text = index.h("q", { class: "gxg-quote" }, index.h("slot", null));
                break;
            case "text-link":
                text = (index.h("a", { href: this.href, target: this.target, class: "gxg-link" }, index.h("slot", null)));
                break;
            case "text-link-gray":
                text = (index.h("a", { href: this.href, target: this.target, class: "gxg-link-gray" }, index.h("slot", null)));
                break;
            case "text-alert-error":
                text = index.h("p", { class: "gxg-alert-error" }, index.h("slot", null));
                break;
            case "text-alert-warning":
                text = index.h("p", { class: "gxg-alert-warning" }, index.h("slot", null));
                break;
            case "text-alert-success":
                text = index.h("p", { class: "gxg-alert-success" }, index.h("slot", null));
                break;
            default:
                text = index.h("p", { class: "gxg-text" }, index.h("slot", null));
        }
