...
const GxgModal = class {
    ...
    watchVisibleHandler() {
        if (this.visible === true) {
            if (!this.silent) {
                const audio = new Audio(index.getAssetPath("./modal-assets/prompt.mp3"));
                setTimeout(function () {
                    audio.play();
                }, 100);
            }
    ...
    render() {
        return this.visible === true ? (index.h(index.Host, { role: "dialog", "aria-hidden": this.modalHidden(), class: {
            ...
            }, style: { width: this.width, "z-index": this.zIndex + 1 } }, index.h("header", { class: "modal__header" }, index.h("span", { class: "modal__header__title" }, this.modalTitle), index.h("gxg-button", { icon: "gemini-tools/close", type: "secondary-icon-only", onClick: this.closeModal.bind(this) })), index.h("div", { class: "modal__container" }, index.h("slot", null)), index.h("footer", { class: "modal__footer" }, index.h("slot", { name: "footer" }))), index.h("div", { class: {
                layer: true,
