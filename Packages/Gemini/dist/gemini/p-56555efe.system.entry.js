System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    ...
    execute: function() {
      t("gxg_form_checkbox", /** @class */ function() {
        function class_1(t) {
          e(this, t), this.change = r(this, "change", 7), 
          /**
        ...
        /*********************************
                METHODS
                *********************************/        return class_1.prototype.compontentDidLoad = function() {
          this.checked && this.disabled && (this.checked = !1, this.checkboxInput.removeAttribute("checked"));
        }, class_1.prototype.changed = function() {
          this.checked = this.checkboxInput.checked, this.change.emit({
            "checkbox id": this.checkboxId,
            "checkbox value": this.checked
          });
        }, class_1.prototype.handlerOnKeyUp = function(t) {
          13 == t.keyCode && (
          //Enter key was pressed
          this.checked ? this.el.removeAttribute("checked") : this.el.setAttribute("checked", "true"), 
          this.change.emit({
            "checkbox id": this.checkboxId,
            "checkbox value": this.checked
          }));
        }, class_1.prototype.ariaChecked = function() {
          return this.checked ? "true" : "false";
        }, class_1.prototype.handleInputClick = function(t) {
          t.stopPropagation();
