System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      e = t.r, o = t.c, r = t.h, i = t.H, n = t.g;
    } ],
    execute: function() {
      t("gxg_drop_down", /** @class */ function() {
        function class_1(t) {
          e(this, t), this.opened = o(this, "opened", 7), this.closed = o(this, "closed", 7), 
          /**
                     * the dropdown width
                     */
          this.width = "240px", 
        ...
        return class_1.prototype.componentWillLoad = function() {
        ...
        }, class_1.prototype.toggleContent = function() {
        ...
        }, class_1.prototype.detectClickOutsideDropDown = function(t) {
          var e = this.el.shadowRoot.querySelector(".content-container"), o = t.x, r = t.y, i = e.getBoundingClientRect();
          o > i.left && o < i.right && r > i.top && r < i.bottom || (this.showContent = !1, 
          ...
          return r(i, null, r("div", {
            ...
            onClick: function() {
              return t.toggleContent();
            }
          }, "" !== this.icon ? r("gxg-icon", {
            class: "icon",
            type: this.icon,
            color: "auto",
            size: "small"
          }) : null, "" !== this.initialButtonText ? this.initialButtonText : null, r("slot", {
            name: "button"
          }), r("span", {
            class: "layer"
          })), this.showContent ? r("div", {
            class: {
              "content-container": !0
            },
            style: {
