import { r as t, h as o, g as e, e as r, H as i } from "./p-eb9dc661.js";

const a = new Map, n = new Map;
...
const l = class {
  ...
  /*********************************
    ...
    *********************************/  connectedCallback() {
    ...
    this.waitUntilVisible(this.element, "50px", () => {
      this.isVisible = !0, this.getIcon();
    });
  }
  disconnectedCallback() {
    void 0 !== this.io && (this.io.disconnect(), this.io = void 0);
  }
  waitUntilVisible(t, o, e) {
    if (this.lazy && "undefined" != typeof window && window.IntersectionObserver) {
      const r = this.io = new window.IntersectionObserver(t => {
        t[0].isIntersecting && (r.disconnect(), this.io = void 0, e());
      }, {
        rootMargin: o
      });
      r.observe(t);
  ...
  async getIcon() {
    if (this.isVisible) {
      if (!this.src) return void (this.svgContent = "");
      a.has(this.src) ? this.svgContent = a.get(this.src) : this.svgContent = await function(t) {
        // see if we already have a request for this url
        let o = n.get(t);
        return o || (
        // we don't already have a request
        o = fetch(t).then(o => {
          if (o.ok) return o.text().then(o => (a.set(t, o), o));
          a.set(t, "");
        }), 
...
const s = {
  ...
  /*********************************
    METHODS
    *********************************/  getSrcPath() {
    return r(`icon-assets/${this.type}.svg`);
  }
  iconSize() {
...
export { l as ch_icon, c as gxg_icon }