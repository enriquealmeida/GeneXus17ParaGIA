import { r as e, h as t, g as r } from "./p-eb9dc661.js";
...
const o = class {
  constructor(t) {
    ...
    /**
         ...
         */
    this.toggleCheckboxes = !1, 
    //STATE
    this.nestedTree = !1, this.mainTree = !1;
  }
  componentWillLoad() {
    "GXG-TREE-ITEM" === this.el.parentElement.tagName && (this.nestedTree = !0);
    //if this is the main tree...
        if ("GXG-TREE-ITEM" !== this.el.parentElement.tagName && (this.mainTree = !0), 
    this.toggleCheckboxes) {
      this.el.querySelectorAll("gxg-tree").forEach((function(e) {
        e.toggleCheckboxes = !0;
      }));
    }
    ...
    null !== e && "GXG-TREE" === e.tagName && e.toggleCheckboxes && (this.toggleCheckboxes = !0);
  }
  componentDidLoad() {
    if (this.checkbox) {
      this.el.querySelectorAll("gxg-tree-item").forEach(e => {
        e.setAttribute("checkbox", "checkbox"), 
      ...
      e.setAttribute("checkbox", "checkbox"), this.checked && e.setAttribute("checked", "checked");
    }
  }
  ...
  toggleIconClickedHandler() {
    this.el.querySelectorAll("gxg-tree-item.not-leaf").forEach(e => {
      e.updateTreeVerticalLineHeight();
    });
  }
  checkboxClickedEventHandler() {
    if (this.toggleCheckboxes) {
      const e = this.el.querySelectorAll("gxg-tree-item");
      let t = !0, r = !0;
      e.forEach((function(e) {
        e.checked ? r = !1 : t = !1;
      }));
      const o = this.el.parentElement;
      "GXG-TREE-ITEM" === o.tagName && (t ? (o.checked = !0, o.indeterminate = !1) : r ? (o.checked = !1, 
      o.indeterminate = !1) : t || r || (o.checked = !0, o.indeterminate = !0));
    }
  }
  render() {
    return this.mainTree ? t("div", {
      class: {
        tree: !0,
        "main-tree": !0
      }
