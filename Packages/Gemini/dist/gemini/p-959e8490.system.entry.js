System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      e = t.r, o = t.e, i = t.h, r = t.H, a = t.g;
    } ],
    execute: function() {
      t("gxg_modal", /** @class */ function() {
        function class_1(t) {
          e(this, t), 
        ...
        return class_1.prototype.componentDidLoad = function() {
        ...
        }, class_1.prototype.closeModal = function() {
          this.layerVisible = !1, this.modalVisible = !1, setTimeout(function() {
            this.visible = !1, this.modalTransition = !1;
          }.bind(this), 250);
        }, class_1.prototype.watchVisibleHandler = function() {
          if (!0 === this.visible) {
            if (!this.silent) {
              var t = new Audio(o("./modal-assets/prompt.mp3"));
              setTimeout((function() {
                t.play();
              }), 100);
            }
        ...
        }, class_1.prototype.modalHidden = function() {
          return this.visible ? "false" : "true";
        }, class_1.prototype.render = function() {
          return !0 === this.visible ? i(r, {
            role: "dialog",
          ...
          }, this.modalTitle), i("gxg-button", {
            icon: "gemini-tools/close",
            type: "secondary-icon-only",
            onClick: this.closeModal.bind(this)
          })), i("div", {
            class: "modal__container"
          }, i("slot", null)), i("footer", {
            class: "modal__footer"
          }, i("slot", {
            name: "footer"
          }))), i("div", {
