System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    ...
    execute: function() {
      t("gxg_drag_box", /** @class */ function() {
        function class_1(t) {
          e(this, t), this.clicked = o(this, "clicked", 7), this.deleted = o(this, "deleted", 7), 
          /**
        ...
        return class_1.prototype.clickedHandler = function() {
          this.clicked.emit(this.el.getAttribute("id"));
        }, class_1.prototype.deleteHandler = function(t) {
          ...
          if (void 0 !== this.title) {
            var t = this.el.shadowRoot.querySelector(".container-content__title");
            this.el.prepend(t);
          }
          ...
          }, void 0 !== this.title ? r("span", {
            class: "container-content__title"
          }, this.title) : null, r("slot", null)), r("div", {
            class: "delete-button-container"
          }, this.deletable ? r("gxg-button", {
