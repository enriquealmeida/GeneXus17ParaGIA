  ...
  return {
    ...
    execute: function() {
      t("gxg_slider", /** @class */ function() {
        ...
        return class_1.prototype.watchHandler = function() {
          this.updateLabel();
          ...
          //Reading Direction
                    "rtl" !== e && "rtl" !== r || (this.rtl = !0), this.updateLabel(), new ResizeObserver((function(e) {
            e.forEach((function() {
              t.updateLabel();
            }));
          })).observe(this.el.shadowRoot.querySelector(".range-slider"));
        }, class_1.prototype.updateLabel = function() {
          var t = this.el.shadowRoot.querySelector(".rs-label"), e = this.value / this.max;
          this.rtl ? t.style.right = e * this.calculateWidth() + "px" : t.style.left = e * this.calculateWidth() + "px", 
          t.innerHTML = this.value.toString(), this.updateBoxValue();
        }, class_1.prototype.updateBoxValue = function() {
        ...
        }, class_1.prototype.rangeSliderChanged = function() {
          this.value = parseInt(this.el.shadowRoot.getElementById("rs-range-line").value), 
          this.updateLabel();
