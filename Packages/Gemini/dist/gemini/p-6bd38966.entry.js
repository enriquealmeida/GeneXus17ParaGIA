import { r as t, c as o, h as e, H as i, g as r } from "./p-eb9dc661.js";

import { s as n } from "./p-cdd40237.js";

import { a, f as s, r as l } from "./p-e8e2654d.js";

const c = class {
  constructor(e) {
    t(this, e), this.input = o(this, "input", 7), this.change = o(this, "change", 7), 
    this.clearButtonClicked = o(this, "clearButtonClicked", 7), this.isRequiredError = !1, 
    /*********************************
        PROPERTIES & STATE
        *********************************/
    /**
  ...
  inputIcon() {
    if (null !== this.iconPosition && null !== this.icon) return this.warning ? e("gxg-icon", {
      type: this.icon,
      size: "small",
      color: "warning"
    }) : this.error ? e("gxg-icon", {
      type: this.icon,
      size: "small",
      color: "error"
    }) : e("gxg-icon", {
  ...
  handleInput(t) {
    t.stopPropagation();
    const o = t.target;
    this.value = o.value, this.input.emit(o.value), a(this, t.target);
  }
  handleChange(t) {
    t.stopPropagation();
    const o = t.target;
    this.value = o.value, this.change.emit(o.value), a(this, t.target);
  }
  clearButtonFunc() {
    const t = this.el.shadowRoot.querySelector("input").value = "";
  ...
  updateGhostSpan() {
    if (this.minimal) {
      ...
      const t = this.el.shadowRoot.querySelector(".ghost-span");
      t.innerHTML = this.value;
      //Then get the ghost span width
      const o = t.offsetWidth + 5;
  ...
  mouseEnterHandler() {
    setTimeout(function() {
      const t = this.el.shadowRoot.querySelector(".input").getBoundingClientRect();
  ...
  componentDidLoad() {
    if (this.minimal) {
      ...
      new IntersectionObserver(function(t) {
        ...
        if (t[0].intersectionRatio <= 0) return;
        const o = this.el.shadowRoot.querySelector(".input"), e = window.getComputedStyle(o), i = this.el.shadowRoot.querySelector(".ghost-span");
        //Set ghostSpan outside of the visible area
        i.style.position = "fixed", i.style.left = "-1000px", i.style.top = "-1000px", i.style.zIndex = "-1000", 
        i.style.opacity = "0", 
        //Set input styles that affect the width to the ghost span
        i.style.fontSize = e.fontSize, i.style.fontFamily = e.fontFamily, i.style.textTransform = e.textTransform, 
        i.style.display = "inline-block", i.style.paddingLeft = e.paddingRight, i.style.paddingRight = e.paddingRight, 
        i.style.letterSpacing = e.letterSpacing, i.style.fontWeight = e.fontWeight;
        //Then get the ghost span width
        const r = i.offsetWidth + 5;
        o.style.width = "0px";
        //get inner-wrapper width
        const n = this.el.shadowRoot.querySelector(".inner-wrapper").offsetWidth - 5;
        //Finally set that width to the input!
                o.style.width = r + "px", o.style.maxWidth = n + "px";
        //Listen to resizeObserver to set the new max-width value on the on the input
        const a = new ResizeObserver(() => {
          o.style.width = "0px";
          const t = this.el.shadowRoot.querySelector(".inner-wrapper").offsetWidth - 5;
          o.style.maxWidth = t + "px", o.style.width = r + "px";
        }), s = this.el.shadowRoot.querySelector(".inner-wrapper");
        a.observe(s);
      }.bind(this)).observe(this.el.shadowRoot.querySelector(".input"));
    }
 // if (this.minimal)
    //Reading Direction
        const t = document.getElementsByTagName("html")[0].getAttribute("dir"), o = document.getElementsByTagName("body")[0].getAttribute("dir");
    //Offset error or warning message if label position is "start"
    if ("rtl" !== t && "rtl" !== o || (this.rtl = !0), "start" === this.labelPosition) {
      //Get label width
      const t = this.el.shadowRoot.querySelector(".label").offsetWidth;
      this.el.shadowRoot.querySelector(".messages-wrapper").style.paddingLeft = t + 5 + "px";
    }
  }
  componentDidUnload() {
  ...
  render() {
    return e(i, {
      ...
      class: "ghost-span"
    }, this.value) : null, e("div", {
      class: "outer-wrapper"
    }, void 0 !== this.label ? e("label", {
      class: {
        label: !0
      }
    }, this.label, l(this)) : "", e("div", {
      class: {
        "inner-wrapper": !0,
    ...
    }), this.inputIcon(), this.clearButton ? e("gxg-icon", {
      class: "clear-button",
      type: "gemini-tools/close",
      size: "small",
      color: "onbackground",
      onClick: this.clearButtonFunc.bind(this)
    }) : null)), s(this.isRequiredError ? e("gxg-form-message", {
      type: "error",
      key: "required-error"
