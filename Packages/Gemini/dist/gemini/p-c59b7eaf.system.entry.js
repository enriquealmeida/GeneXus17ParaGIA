System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      o = t.r, r = t.c, a = t.h, i = t.g;
    } ],
    execute: function() {
      t("gxg_tab_button", /** @class */ function() {
        function class_1(t) {
          o(this, t), this.tabActivated = r(this, "tabActivated", 7), 
          /**
                     * The button label
                     */
          this.tabLabel = null, 
        ...
        //Click functions
                return class_1.prototype.tabButtonClicked = function() {
          this.isSelected = !0;
          var t = parseInt(this.el.getAttribute("data-index"), 10);
          this.tabActivated.emit({
            tab: this.tab,
            index: t
          });
        }, class_1.prototype.printIcon = function() {
          if (null !== this.icon) return this.disabled ? a("gxg-icon", {
            color: "disabled",
            type: this.icon
          }) : a("gxg-icon", {
            type: this.icon
          ...
          }, this.printIcon(), a("span", {
            class: "tab-button__text"
          }, this.tabLabel)), a("slot", null));
