System.register([ "./p-d8a20c31.system.js", "./p-08984d7d.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      e = t.r, r = t.h, o = t.H, a = t.g;
    }, function(t) {
      i = t.s;
    } ],
    execute: function() {
      t("gxg_button_group", /** @class */ function() {
        function class_1(t) {
          e(this, t), 
          /**
        ...
        }, class_1.prototype.setActiveButton = function(t) {
        ...
        }, class_1.prototype.setInitialActiveValue = function() {
          var t = this, e = "", r = this.el.children, o = [];
          Array.from(r).forEach((function(t) {
            var e = t;
            e.setAttribute("tabindex", "0"), "" !== e.getAttribute("id") && o.push(e.getAttribute("id"));
          })), 
          //if defaultSelectedBtnId is equal to any id of the array, set that button as active
          void 0 !== this.defaultSelectedBtnId && "" !== this.defaultSelectedBtnId.replace(/\s/g, "") && o.includes(this.defaultSelectedBtnId) ? o.includes(this.defaultSelectedBtnId) && Array.from(r).forEach((function(r) {
            var o = r;
            o.id == t.defaultSelectedBtnId && (
            //set the value to the active button value
            e = t.defaultSelectedBtnId = o.getAttribute("value"), o.setAttribute("data-active", ""), 
            o.setAttribute("aria-pressed", "true"));
          })) : (
          // defaultSelectedBtnId is not part of any button id
          //By default, set the first button as the active button
          this.el.children[0].setAttribute("data-active", ""), e = this.el.children[0].getAttribute("value"), 
          this.el.children[0].setAttribute("aria-pressed", "true")), this.value = e;
        }, class_1.prototype.detectFocus = function(t) {
          if (this.el === document.activeElement) {
            var e = this.el.children, r = e.length;
        ...
        }, class_1.prototype.tabIndex = function() {
          return this.disabled ? "-1" : "0";
        }, class_1.prototype.render = function() {
          var t = null;
          return void 0 !== this.buttonGroupTitle && (t = r("header", {
            class: "button-group-header"
          }, r("label", {
            class: "button-group-header-title"
          }, this.buttonGroupTitle))), r(o, {
