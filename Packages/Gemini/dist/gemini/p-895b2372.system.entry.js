System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      e = t.r, r = t.h, o = t.e, a = t.H, i = t.g;
    } ],
    execute: function() {
      t("gxg_alert", /** @class */ function() {
        function class_1(t) {
          e(this, t), 
          /*********************************
                    PROPERTIES & STATE
        ...
        /*********************************
        ...
        }, class_1.prototype.closeIconColor = function() {
          return "notice" === this.type ? "negative" : "onbackground";
        }, class_1.prototype.printTitle = function() {
          if (void 0 !== this.title) return r("h2", {
            class: "alert-message--title"
          }, this.title);
        }, class_1.prototype.setAlertInactive = function() {
          this.active = !1, this.el.removeAttribute("role");
        }, class_1.prototype.validateName = function(t) {
          var e, r = this;
          //timing
          ...
          !0 === t && (this.el.setAttribute("role", "alert"), setTimeout((function() {
            r.setAlertInactive();
          }), parseInt(getComputedStyle(document.documentElement).getPropertyValue("--timing-" + e))));
        }, class_1.prototype.defineWidth = function() {
          if (this.fullWidth) {
            var t = getComputedStyle(document.documentElement).getPropertyValue("--spacing-lay-" + this.leftRight);
          ...
          return this.width;
        }, class_1.prototype.alertHidden = function() {
          if (this.active) {
            var t;
            if (!this.silent) "warning" === this.type ? t = new Audio(o("./alert-assets/warning.mp3")) : "error" === this.type && (t = new Audio(o("./alert-assets/error.mp3"))), 
            setTimeout((function() {
              t.play();
            }), 100);
            return "false";
          ...
          return "true";
        }, class_1.prototype.transform = function(t) {
          return "center" === this.position ? this.rtl ? "translateY(-" + t + ") translateX(50%)" : "translateY(-" + t + ") translateX(-50%)" : "translateY(-" + t + ")";
        }, class_1.prototype.render = function() {
          var t, e;
          "no-space" === this.leftRight ? t = "0" : t = getComputedStyle(document.body).getPropertyValue("--spacing-lay-" + this.leftRight).replace(/\s/g, "");
          "no-space" === this.bottom ? e = "0" : e = getComputedStyle(document.body).getPropertyValue("--spacing-lay-" + this.bottom).replace(/\s/g, "");
          return r(a, {
            role: "alert",
