...
const i = class {
  constructor(r) {
    t(this, r), this.change = e(this, "change", 7), this.changeInternal = e(this, "changeInternal", 7), 
    this.keyPressed = e(this, "keyPressed", 7), 
    /**
  ...
  render() {
    return r(o, null, r("label", {
      class: "label"
    }, r("input", {
      ref: t => this.radioInput = t,
      type: "radio",
      name: this.name,
      id: this.RadioId,
      value: this.value,
