System.register([], (function() {
  ...
  return {
    execute: function() {
      ...
      var h = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gm;
      function normalizeValue(t) {
        var r = (t = t.replace(/\s+/gim, " ").trim()).endsWith("!important");
        return r && (t = t.substr(0, t.length - "!important".length).trim()), {
          value: t,
          important: r
        };
      }
      ...
      function addGlobalLink(t, r, n) {
        ...
        return fetch(o).then((function(t) {
          ...
          if (function(t) {
            return t.indexOf("var(") > -1 || d.test(t);
          }(a) && n.parentNode) {
            (function(t) {
              return m.lastIndex = 0, m.test(t);
            })(a) && (a = function(t, r) {
              var n = r.replace(/[^/]*$/, "");
              return t.replace(m, (function(t, r) {
                var o = n + r;
      ...
      var v, g = function() {
        ...
        return e.prototype.i = function() {
          ...
          return i.setAttribute("data-no-shim", ""), a.usesCssVars ? o ? (i["s-sc"] = r = a.scopeId + "-" + this.count, 
      ...
      !(v = "undefined" != typeof window && window) || v.__cssshim || v.CSS && v.CSS.supports && v.CSS.supports("color", "var(--c)") || (v.__cssshim = new g(v, v.document));
    }
  };
}));