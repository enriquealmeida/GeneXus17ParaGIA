System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    ...
    execute: function() {
      t("gxg_accordion", /** @class */ function() {
        function class_1(t) {
          e(this, t), 
          /**
        ...
        return class_1.prototype.itemClickedHandler = function(t) {
          var e = this;
          t.stopPropagation(), this.accordions.forEach((function(o) {
            var r = o.itemId;
            e.singleItemOpen ? r === t.detail ? "open" === o.status ? o.status = "closed" : o.status = "open" : o.status = "closed" : r === t.detail && ("open" === o.status ? o.status = "closed" : o.status = "open");
          }));
        }, class_1.prototype.itemLoadedHandler = function() {
          this.setupAccordions();
        }, class_1.prototype.componentWillLoad = function() {
          this.setupAccordions();
        }, class_1.prototype.setupAccordions = function() {
          var t = this;
          if (this.accordions = Array.from(this.el.querySelectorAll(":scope > gxg-accordion-item")), 
          //Disabled
          this.disabled && this.accordions.forEach((function(t) {
            t.status = "closed";
          })), this.singleItemOpen) {
            /* If "single-item-open" is true, and more than one accordion has the "open" property,
                        show only the first accordion open.*/
            var e = 0;
            if (this.accordions.forEach((function(t) {
              "open" === t.getAttribute("status") && e++;
            })), e > 1) {
              var o = !1;
              this.accordions.forEach((function(t) {
                "open" === t.getAttribute("status") && (o ? t.setAttribute("status", "closed") : o = !0);
              }));
            }
          }
          this.accordions.forEach((function(e) {
            e.setAttribute("mode", t.mode), t.noPadding && e.setAttribute("no-padding", ""), 
            t.disabled && e.setAttribute("disabled", "disabled");
          }));
