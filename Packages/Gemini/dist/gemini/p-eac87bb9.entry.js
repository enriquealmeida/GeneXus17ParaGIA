import { r as t, h as o, H as a, g as n } from "./p-eb9dc661.js";

import { s as e } from "./p-cdd40237.js";
...
const r = class {
  ...
  /*********************************
    ...
    *********************************/  componentDidLoad() {
    ...
    if (("primary-icon-only" === this.type || "secondary-icon-only" === this.type) && this.el.querySelector(":scope > [slot='icon']")) {
      ...
      const t = this.el.querySelector(":scope > [slot='icon']").getAttribute("type");
  ...
  regularIcon() {
    if ("primary-text-only" !== this.type && "secondary-text-only" !== this.type && void 0 !== this.icon) return o("gxg-icon", {
      type: this.icon,
  ...
  iconSize() {
    let t;
    return t = "secondary-icon-only" === this.type || "tertiary" === this.type ? "regular" : "small", 
    t;
  }
  iconColor() {
    let t;
  ...
  render() {
    return o(a, {
      ...
      ref: t => this.button = t,
      tabindex: "0"
    }, this.ghostIcon(), this.regularIcon(), this.type.includes("text") || "outlined" === this.type ? o("span", {
      class: "text"
    }, o("slot", null)) : null));
  }
  get el() {
