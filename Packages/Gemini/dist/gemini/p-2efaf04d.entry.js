import { r as t, h as e } from "./p-eb9dc661.js";

const i = class {
  constructor(e) {
    t(this, e), this.layerZIndex = 100, this.initiateDemo = !1, this.modalMessage = "Welcome to the demo!", 
  ...
  setCoordinates(t) {
    //MESSAGE POSITION
    const e = t.getBoundingClientRect(), i = e.x, o = e.y, r = e.right, n = e.height, a = e.top, s = e.width;
    this.position = t.getAttribute("position");
    switch (this.position) {
     case "bottom-start":
      this.topPosition = o + n + 7 + "px", this.rtl ? (this.leftPosition = "auto", this.rightPosition = window.innerWidth - r + "px") : (this.leftPosition = i + "px", 
      this.rightPosition = "auto");
      break;

     case "bottom-center":
      this.leftPosition = i + s / 2 + "px", this.rightPosition = "auto", this.topPosition = o + n + 7 + "px";
      break;

     case "bottom-end":
      this.topPosition = o + n + 7 + "px", this.rtl ? (this.leftPosition = i + "px", this.rightPosition = "auto") : (this.leftPosition = "auto", 
      this.rightPosition = window.innerWidth - r + "px");
      break;

     case "top-start":
      this.topPosition = a - 7 + "px", this.rtl ? (this.leftPosition = "auto", this.rightPosition = window.innerWidth - r + "px") : (this.leftPosition = i + "px", 
      this.rightPosition = "auto");
      break;

     case "top-center":
      this.leftPosition = i + s / 2 + "px", this.topPosition = a - 7 + "px", this.rightPosition = "auto";
      break;

     case "top-end":
      this.topPosition = a - 7 + "px", this.rtl ? (this.leftPosition = i + "px", this.rightPosition = "auto") : (this.leftPosition = "auto", 
      this.rightPosition = window.innerWidth - r + "px");
    }
    //Message
  ...
  render() {
    if (!0 === this.initiateDemo) return [ e("div", {
      class: {
        tooltip: !0,
    ...
    }, this.currentItem + 1 !== this.numberOfItems ? "Next" : "Finish"))), e("div", {
      class: {
        layer: !0,
