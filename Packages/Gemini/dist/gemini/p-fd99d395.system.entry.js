System.register([ "./p-d8a20c31.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      e = t.r, i = t.h, o = t.H, r = t.g;
    } ],
    execute: function() {
      t("gxg_window", /** @class */ function() {
        function class_1(t) {
          e(this, t), 
          /**
        ...
        return class_1.prototype.dragElement = function(t, e) {
          var i = 0, o = 0, r = 0, n = 0;
          function dragElm(a) {
        ...
        }, class_1.prototype.resizeElement = function(t, e) {
          //resize top
          var i = 0, o = 0, r = 0;
          //drop resize element
                    function dropElm() {
          ...
          var t = this.el.shadowRoot.querySelectorAll("#draggable-resizable-div>div");
        ...
        }, class_1.prototype.closeWindow = function() {
          this.showWindow = !1, setTimeout(function() {
            this.displayWindow = !1;
          }.bind(this), 200);
        }, class_1.prototype.displayWindowHandler = function() {
          !0 === this.displayWindow && setTimeout(function() {
            this.showWindow = !0;
          }.bind(this), 50);
        }, class_1.prototype.setInitialWidth = function() {
          var t = parseInt(this.initialWidth.substring(0, this.initialWidth.length - 2)), e = parseInt(this.minWidth.substring(0, this.minWidth.length - 2)), i = parseInt(this.maxWidth.substring(0, this.maxWidth.length - 2));
          return t < e ? this.minWidth : t > i ? this.maxWidth : this.initialWidth;
        }, class_1.prototype.setInitialHeight = function() {
          var t = parseInt(this.initialHeight.substring(0, this.initialHeight.length - 2)), e = parseInt(this.minHeight.substring(0, this.minHeight.length - 2)), i = parseInt(this.maxHeight.substring(0, this.maxHeight.length - 2));
          ...
          return i(o, {
            ...
            ref: function(e) {
              return t.draggableResizableDiv = e;
            },
            style: {
          ...
          }, "" !== this.titleIcon ? i("gxg-icon", {
            class: "title-icon",
            color: "auto",
            size: "regular",
            type: this.titleIcon
          }) : null, "" !== this.windowTitle ? this.windowTitle : null), i("gxg-button", {
            class: {
              "delete-icon": !0
            },
            icon: "menus/delete",
