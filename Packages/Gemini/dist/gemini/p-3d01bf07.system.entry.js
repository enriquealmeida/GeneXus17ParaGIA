System.register([ "./p-d8a20c31.system.js", "./p-08984d7d.system.js" ], (function(t) {
  ...
  return {
    setters: [ function(t) {
      o = t.r, n = t.h, a = t.H, e = t.g;
    }, function(t) {
      r = t.s;
    } ],
    execute: function() {
      t("gxg_button", /** @class */ function() {
        function class_1(t) {
          o(this, t), 
          /*********************************
                    PROPERTIES & STATE
          ...
          /**
                     ...
                     */
          this.buttonStylesEditable = !1, this.mouseEnter = !1, this.focusIn = !1;
        }
        /*********************************
                METHODS
                *********************************/        return class_1.prototype.componentDidLoad = function() {
          // Set aria-label to host
          if (("primary-icon-only" === this.type || "secondary-icon-only" === this.type) && this.el.querySelector(":scope > [slot='icon']")) {
            //Also, an icon must be provided, in order to know the button purpose.
            //The icon purpose is defined from the icon "type" property.
            var t = this.el.querySelector(":scope > [slot='icon']").getAttribute("type");
            this.el.setAttribute("aria-label", t);
          }
          //Set a part attribute to the button if buttonStylesEditable is true
                    this.buttonStylesEditable && this.el.shadowRoot.querySelector("button").setAttribute("part", "native-button");
        }, class_1.prototype.ghostIcon = function() {
          return n("gxg-icon", {
            class: "ghost-icon",
          ...
          //This is a workaround I found for alligning vertically the buttons that have no icon, with the buttons that do have icons.
                }, class_1.prototype.regularIcon = function() {
          if ("primary-text-only" !== this.type && "secondary-text-only" !== this.type && void 0 !== this.icon) return n("gxg-icon", {
            type: this.icon,
            color: this.iconColor(),
            size: this.iconSize()
          });
        }, class_1.prototype.iconSize = function() {
          return "secondary-icon-only" === this.type || "tertiary" === this.type ? "regular" : "small";
        }, class_1.prototype.iconColor = function() {
          var t;
          return this.type.includes("primary") ? (t = "negative", this.disabled && (t = "ondisabled")) : this.type.includes("secondary") ? t = this.disabled ? "disabled" : this.mouseEnter ? "primary-hover" : this.focusIn ? "primary-active" : "primary-enabled" : this.type.includes("tertiary") && (t = this.disabled ? "disabled" : this.alwaysBlack ? "alwaysblack" : this.negative ? "negative" : "onbackground"), 
          t;
        }, class_1.prototype.clickHandler = function(t) {
          this.disabled && t.preventDefault();
        }, class_1.prototype.handleFocus = function(t) {
          t.target === this.el && this.button.focus();
        }, class_1.prototype.onMouseEnter = function() {
          this.mouseEnter = !0;
        }, class_1.prototype.onMouseLeave = function() {
          this.mouseEnter = !1;
        }, class_1.prototype.onFocusIn = function() {
          this.focusIn = !0, this.mouseEnter = !1;
        }, class_1.prototype.onFocusOut = function() {
          this.focusIn = !1;
          ...
          return n(a, {
            ...
            class: {
              button: !0,
              "button--primary-text-only": "primary-text-only" === this.type,
              "button--primary-text-icon": "primary-text-icon" === this.type,
              "button--primary-icon-only": "primary-icon-only" === this.type,
              "button--secondary-text-only": "secondary-text-only" === this.type,
              "button--secondary-text-icon": "secondary-text-icon" === this.type,
              "button--secondary-icon-only": "secondary-icon-only" === this.type,
              "button--outlined": "outlined" === this.type,
              "button--disabled": !0 === this.disabled,
              "button--tertiary": "tertiary" === this.type,
              "button--fullwidth": !0 === this.fullWidth,
              large: r.large
            },
            ...
            disabled: !0 === this.disabled,
            ref: function(o) {
              return t.button = o;
            },
            tabindex: "0"
          }, this.ghostIcon(), this.regularIcon(), this.type.includes("text") || "outlined" === this.type ? n("span", {
            class: "text"
          }, n("slot", null)) : null));
