import { r as t, c as e, h as i, H as o, g as a } from "./p-eb9dc661.js";

const r = class {
  constructor(i) {
    t(this, i), this.accordionItemClicked = e(this, "accordionItemClicked", 7), this.accordionItemLoaded = e(this, "accordionItemLoaded", 7), 
    this.accordionTitleClicked = e(this, "accordionTitleClicked", 7), this.titleChanged = e(this, "titleChanged", 7), 
    /**
  ...
  componentWillLoad() {
    ...
    null !== this.el.querySelector("[slot=meta]") && (this.hasSlottedMeta = !0);
  }
  componentDidLoad() {
    //Get accordion mode
    this.accordionMode = this.el.parentElement.getAttribute("mode");
    null !== this.el.querySelector("gxg-accordion") && (this.nestedAccordion = !0);
    //Detect click on input ".outer-wrapper"
        const t = this.el.shadowRoot.querySelector("gxg-form-text");
    if (null !== t) {
      t.shadowRoot.querySelector(".outer-wrapper").addEventListener("click", function(t) {
  ...
  gxgFormTextClickedHandler(t) {
    t.stopPropagation();
  }
  changedTitleHandler(t) {
  ...
  render() {
    ...
    }, null === this.titleIcon || "classical" !== this.accordionMode && "boxed" !== this.accordionMode ? null : i("div", {
    ...
    i("gxg-form-text", {
      onChange: t => this.changedTitleHandler(t),
      minimal: !0,
      ...
      "text-style": "title-02",
      class: "input"
    })), "classical" !== this.mode && "boxed" !== this.mode || null === this.itemSubtitle ? null : i("h2", {
      class: "item__header__button__title-subtitle__subtitle",
      title: this.itemSubtitleTrimmed(this.itemSubtitle)
    }, this.itemSubtitle.length > 50 ? this.itemSubtitle.slice(0, 50) + "..." : this.itemSubtitle)), i("div", {
      class: "item__header__button__meta-icon-wrapper"
    }, !this.hasSlottedMeta || "classical" !== this.mode && "boxed" !== this.mode ? null : i("div", {
      class: "item__header__button__meta-icon-wrapper__meta"
    }, i("slot", {
      name: "meta"
    })), i("div", {
      class: "item__header__button__meta-icon-wrapper__icon"
    }, this.printIcon())))), "open" !== this.status || this.disabled ? "" : i("main", {
