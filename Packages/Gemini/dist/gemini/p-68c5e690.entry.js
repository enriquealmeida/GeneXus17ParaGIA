import { r as e, h as t, H as r, g as o } from "./p-eb9dc661.js";

import { c as a, u as i } from "./p-9583448a.js";

import { s as l } from "./p-cdd40237.js";

const z = i(a((function(e, t) {
  window, e.exports = function(e) {
    ...
    function f(e, t, r) {
      ...
      for (var te = 1; te <= ee; te++) {
        var re = (te - 1) % 7, oe = B[re], ae = te - (Q >= 0 ? Q : 7 + Q), ne = new Date(a, o, ae), ie = H[+ne], se = ae < 1 || ae > X, le = se ? ae < 1 ? -1 : 1 : 0, ce = se && !T, de = ce ? "" : ne.getDate(), ue = 0 === re || 6 === re, ge = G !== $, fe = "qs-square " + oe;
        ie && !ce && (fe += " qs-event"), se && (fe += " qs-outside-current-month"), !T && se || (fe += " qs-num"), 
        +ne == +i && (fe += " qs-active"), (W[+ne] || t.disabler(ne) || ue && t.noWeekends || z && +ne < +z || l && +ne > +l) && !ce && (fe += " qs-disabled"), 
        +g(new Date) == +ne && (fe += " qs-current"), +ne === G && $ && ge && (fe += " qs-range-start"), 
        +ne > G && +ne < $ && (fe += " qs-range-middle"), +ne === $ && G && ge && (fe += " qs-range-end"), 
        ce && (fe += " qs-empty", de = ""), Z.push('<div class="' + fe + '" data-direction="' + le + '">' + de + "</div>");
      }
  ...
  componentDidLoad() {
    ...
    if (void 0 !== this.defaultDate && "" !== this.defaultDate) {
      ...
      const e = new Date(this.defaultDate);
    ...
    //default date
        const o = r.getFullYear(), a = r.getMonth(), i = r.getDate(), l = new Date(this.minDate), T = l.getFullYear(), B = l.getMonth(), W = l.getDate(), J = new Date(this.maxDate), H = J.getFullYear(), U = J.getMonth(), G = J.getDate(), $ = this.el.shadowRoot.querySelector("#date-picker");
    ...
    z($, {
      ...
      dateSelected: new Date(o, a, i),
      maxDate: new Date(H, U, G),
      minDate: new Date(T, B, W),
      startDate: new Date,
      showAllDates: !0,
      // Disabling things.
      noWeekends: this.noWeekends,
      disabler: e => 2 === e.getDay() && 9 === e.getMonth(),
