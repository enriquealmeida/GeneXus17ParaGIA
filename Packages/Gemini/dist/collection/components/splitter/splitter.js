import { Component, Host, h, Prop, State, Element, Event, Method, } from "@stencil/core";
...
export class GxgSplitter {
    ...
    render() {
        return (h(Host, { class: { "collapsed-to-zero": this.collapsedToZero } },
            h("slot", null)));
    }
    static get is() { return "gxg-splitter"; }
    ...
    static get properties() { return {
        ...
        "minSize": {
            ...
            "docs": {
                "tags": [],
                "text": "The splitter min. sizes in pixels"
            },
            "attribute": "min-size",
            "reflect": false,
            "defaultValue": "\"0,0\""
        ...
        "sizes": {
            ...
            "docs": {
                "tags": [],
                "text": "The splitter initial sizes, in percentages. The sum should equal 100"
            },
            "attribute": "sizes",
            "reflect": false,
            "defaultValue": "\"50,50\""
    ...
    static get events() { return [{
            ...
            "docs": {
                "tags": [],
                "text": "This event is fired when the gutter is being dragged"
            },
            "complexType": {
                "original": "any",
                "resolved": "any",
            ...
            "docs": {
                "tags": [],
                "text": "This event is fired when the dragging has stopped"
            },
            "complexType": {
                "original": "any",
                "resolved": "any",
    ...
    static get methods() { return {
        "collapse": {
            "complexType": {
                "signature": "(split: number, forceCollapseZero?: boolean) => Promise<void>",
                "parameters": [{
                        "tags": [],
                        "text": ""
                    }, {
            ...
            "docs": {
                "text": "This method allows to collapse the split passsed as argument",
                "tags": []
            }
        }
    }; }
