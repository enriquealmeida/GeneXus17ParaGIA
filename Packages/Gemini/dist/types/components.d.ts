...
import { background as background1, elevation, padding as padding1 } from "./components/card/card";
...
import { IconPosition, LabelPosition, Style } from "./components/form-text/form-text";
...
declare global {
    ...
    interface HTMLGxgComboElement extends Components.GxgCombo, HTMLStencilElement {
    }
    var HTMLGxgComboElement: {
        prototype: HTMLGxgComboElement;
        new (): HTMLGxgComboElement;
    };
    interface HTMLGxgComboItemElement extends Components.GxgComboItem, HTMLStencilElement {
    }
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "gxg-combo": LocalJSX.GxgCombo & JSXBase.HTMLAttributes<HTMLGxgComboElement>;
            "gxg-combo-item": LocalJSX.GxgComboItem & JSXBase.HTMLAttributes<HTMLGxgComboItemElement>;
            ...
            "gxg-listbox": LocalJSX.GxgListbox & JSXBase.HTMLAttributes<HTMLGxgListboxElement>;
            "gxg-listbox-item": LocalJSX.GxgListboxItem & JSXBase.HTMLAttributes<HTMLGxgListboxItemElement>;
