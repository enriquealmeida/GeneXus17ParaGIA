...
var setContentReference = function (elm) {
    ...
    // create a node to represent where the original
    // content was first placed, which is useful later on
    var contentRefElm = (elm['s-cr'] = doc.createComment("content-ref (host=" + elm.localName + ")"));
...
export { CSS as C, Host as H, NAMESPACE as N, promiseResolve as a, bootstrapLazy as b, createEvent as c, doc as d, getAssetPath as e, getRenderingRef as f, getElement as g, h, forceUpdate as i, plt as p, registerInstance as r, win as w };
