...
var GxgStepper = /** @class */ (function () {
    ...
    METHODS
    *********************************/
    GxgStepper.prototype.componentDidLoad = function () {
        //Reading Direction
    ...
    GxgStepper.prototype.minus = function () {
        if (this.value === this.max) {
    ...
    GxgStepper.prototype.plus = function () {
        if (this.value === this.min) {
    ...
    GxgStepper.prototype.watchHandler = function (newValue) {
        this.stepperInput.emit(newValue);
    };
    GxgStepper.prototype.render = function () {
        var _this = this;
        return (h(Host, { class: {
                rtl: this.rtl
            } }, h("label", { class: "label" }, this.label), h("div", { class: "outer-wrapper" }, h("button", { ref: function (el) { return (_this.minusButton = el); }, class: "button button--minus", onClick: this.minus.bind(this), tabindex: "0" }, "-"), h("span", { class: "value-container" }, h("span", { class: "value-container__value" }, this.value)), h("button", { ref: function (el) { return (_this.plusButton = el); }, class: "button button--plus", onClick: this.plus.bind(this), tabindex: "0" }, "+"))));
    };
    Object.defineProperty(GxgStepper.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(GxgStepper, "watchers", {
        get: function () {
            return {
                "value": ["watchHandler"]
            };
...
export { GxgStepper as gxg_stepper };
