...
var GxgFormRadio = /** @class */ (function () {
    ...
    METHODS
    *********************************/
    GxgFormRadio.prototype.componentDidLoad = function () {
        if (this.checked) {
    ...
    GxgFormRadio.prototype.watchHandler = function (newValue) {
        if (newValue === false) {
            this.radioInput.removeAttribute("checked");
        }
        if (newValue === true) {
    ...
    GxgFormRadio.prototype.selectRadio = function () {
        this.changeInternal.emit({
            id: this.RadioId,
            value: this.value,
        });
    };
    GxgFormRadio.prototype.handlerOnKeyDown = function (event) {
        if (event.keyCode == 9) {
            //tab key was pressed
            if (event.shiftKey) {
    ...
    GxgFormRadio.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("label", { class: "label" }, h("input", { ref: function (el) { return (_this.radioInput = el); }, type: "radio", name: this.name, id: this.RadioId, value: this.value, onClick: this.selectRadio.bind(this), disabled: this.disabled, onKeyDown: this.handlerOnKeyDown.bind(this) }), h("span", { class: { radiobtn: true, "radiobtn--error": this.error } }), this.label)));
    };
    Object.defineProperty(GxgFormRadio.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(GxgFormRadio, "watchers", {
        get: function () {
            return {
...
GxgFormRadio.style = formRadioCss;
export { GxgFormRadio as gxg_form_radio };
