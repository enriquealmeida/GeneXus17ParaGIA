...
var GxgButton = /** @class */ (function () {
    ...
    METHODS
    *********************************/
    GxgButton.prototype.componentDidLoad = function () {
    ...
    GxgButton.prototype.ghostIcon = function () {
    ...
    GxgButton.prototype.regularIcon = function () {
    ...
    GxgButton.prototype.iconSize = function () {
        var iSize;
    ...
    GxgButton.prototype.iconColor = function () {
        var iColor;
    ...
    GxgButton.prototype.clickHandler = function (e) {
        if (this.disabled) {
            e.preventDefault();
        }
    };
    GxgButton.prototype.handleFocus = function (focusEvent) {
        if (focusEvent.target !== this.el) {
            return;
        }
        this.button.focus();
    };
    GxgButton.prototype.onMouseEnter = function () {
        this.mouseEnter = true;
    };
    GxgButton.prototype.onMouseLeave = function () {
        this.mouseEnter = false;
    };
    GxgButton.prototype.onFocusIn = function () {
        this.focusIn = true;
        this.mouseEnter = false;
    };
    GxgButton.prototype.onFocusOut = function () {
        this.focusIn = false;
    };
    GxgButton.prototype.render = function () {
        var _this = this;
        return (h(Host, { role: "button", class: {
                ...
                large: state.large,
            }, onClick: this.clickHandler.bind(this), onMouseEnter: this.onMouseEnter.bind(this), onMouseLeave: this.onMouseLeave.bind(this), onfocusin: this.onFocusIn.bind(this), onfocusout: this.onFocusOut.bind(this) }, this.disabled ? h("div", { class: "disabled-layer" }) : null, h("button", { class: "button-native gxg-text-general", disabled: this.disabled === true, ref: function (el) { return (_this.button = el); }, tabindex: "0" }, this.ghostIcon(), this.regularIcon(), this.type.includes("text") || this.type === "outlined" ? (h("span", { class: "text" }, h("slot", null))) : null)));
    };
    Object.defineProperty(GxgButton.prototype, "el", {
