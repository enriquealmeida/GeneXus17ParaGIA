...
var GxgFormText = /** @class */ (function () {
    ...
    GxgFormText.prototype.watchHandler = function (newValue, oldValue) {
    ...
    METHODS
    *********************************/
    GxgFormText.prototype.iconPositionFunc = function () {
        if (this.iconPosition !== null && this.icon !== null) {
            return this.iconPosition;
        }
    };
    GxgFormText.prototype.inputIcon = function () {
        if (this.iconPosition !== null && this.icon !== null) {
            if (this.warning) {
    ...
    GxgFormText.prototype.handleInput = function (e) {
        e.stopPropagation();
        var target = e.target;
    ...
    GxgFormText.prototype.handleChange = function (e) {
        e.stopPropagation();
        var target = e.target;
        this.value = target.value;
    ...
    GxgFormText.prototype.clearButtonFunc = function () {
        var value = (this.el.shadowRoot.querySelector("input").value = "");
        this.change.emit(value);
        this.clearButtonClicked.emit("clear button was clicked");
    };
    GxgFormText.prototype.updateGhostSpan = function () {
        if (this.minimal) {
            //Update ghost span content, and then get and apply the width from the ghost span
            var ghostSpan = this.el.shadowRoot.querySelector(".ghost-span");
            ghostSpan.innerHTML = this.value;
            //Then get the ghost span width
            var ghostSpanWidth = ghostSpan.offsetWidth + 5;
            var input = this.el.shadowRoot.querySelector(".input");
            //Finally set that width to the input!
            input.style.width = ghostSpanWidth + "px";
        }
    };
    GxgFormText.prototype.mouseEnterHandler = function () {
        setTimeout(function () {
            var inputText = this.el.shadowRoot.querySelector(".input");
            //Contextual menu coordinates
            var inputTextArea = inputText.getBoundingClientRect();
    ...
    GxgFormText.prototype.mouseOutHandler = function () {
        this.cursorInside = false;
    };
    GxgFormText.prototype.mouseMoveHandler = function (e) {
        this.mouseCoordinates["x"] = e.clientX;
        this.mouseCoordinates["y"] = e.clientY;
    };
    GxgFormText.prototype.componentDidLoad = function () {
        if (this.minimal) {
            ...
            **************/
            var intersectionObserver = new IntersectionObserver(function (entries) {
                ...
                if (entries[0].intersectionRatio <= 0)
                    return;
                var input = this.el.shadowRoot.querySelector(".input");
                var inputComputedStyles = window.getComputedStyle(input);
                var ghostSpan = this.el.shadowRoot.querySelector(".ghost-span");
                ...
                var innerWrapperWidth = this.el.shadowRoot.querySelector(".inner-wrapper")
                    .offsetWidth - 5;
                //Finally set that width to the input!
                input.style.width = ghostSpanWidth + "px";
                ...
                var resizeObserver = new ResizeObserver(function () {
                    input.style.width = "0px";
                    var innerWrapperWidth = _this.el.shadowRoot.querySelector(".inner-wrapper").offsetWidth - 5;
                    input.style.maxWidth = innerWrapperWidth + "px";
                    input.style.width = ghostSpanWidth + "px";
                });
                var innerWrapper = this.el.shadowRoot.querySelector(".inner-wrapper");
        ...
        if (this.labelPosition === "start") {
            ...
            var messagesWrapper = this.el.shadowRoot.querySelector(".messages-wrapper");
            messagesWrapper.style.paddingLeft = labelWidth + 5 + "px";
        }
    };
    GxgFormText.prototype.componentDidUnload = function () {
        if (this.minimal) {
    ...
    LISTEN
    *********************************/
    GxgFormText.prototype.handleFocus = function (focusEvent) {
        if (focusEvent.target !== this.el) {
            return;
        }
        this.textInput.focus();
    };
    GxgFormText.prototype.type = function () {
        if (this.password) {
            return "password";
        }
        else {
    ...
    GxgFormText.prototype.render = function () {
        var _this = this;
        return (h(Host, { role: "textbox", "aria-label": this.label, "icon-position": this.iconPositionFunc(), style: {
                ...
                rtl: this.rtl,
                large: state.large,
            }, tabindex: "0" }, this.minimal ? h("span", { class: "ghost-span" }, this.value) : null, h("div", { class: "outer-wrapper" }, this.label !== undefined ? (h("label", { class: {
                label: true,
