...
var GxgModal = /** @class */ (function () {
    ...
    GxgModal.prototype.componentDidLoad = function () {
        this.el.style.display = "block";
        this.el.style.zIndex = "-1";
    };
    GxgModal.prototype.closeModal = function () {
        this.layerVisible = false;
        this.modalVisible = false;
        setTimeout(function () {
            this.visible = false;
    ...
    GxgModal.prototype.watchVisibleHandler = function () {
        if (this.visible === true) {
            if (!this.silent) {
                var audio_1 = new Audio(getAssetPath("./modal-assets/prompt.mp3"));
                setTimeout(function () {
                    audio_1.play();
                }, 100);
            }
    ...
    GxgModal.prototype.modalHidden = function () {
        if (this.visible) {
            return "false";
        }
        else {
    ...
    GxgModal.prototype.render = function () {
    ...
    Object.defineProperty(GxgModal, "assetsDirs", {
        get: function () { return ["modal-assets"]; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(GxgModal.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(GxgModal, "watchers", {
        get: function () {
            return {
