...
var GxgAccordion = /** @class */ (function () {
    ...
    GxgAccordion.prototype.itemClickedHandler = function (event) {
        var _this = this;
        event.stopPropagation();
        this.accordions.forEach(function (accordion) {
            var id = accordion.itemId;
            if (_this.singleItemOpen) {
                if (id === event.detail) {
    ...
    GxgAccordion.prototype.itemLoadedHandler = function () {
        this.setupAccordions();
    };
    GxgAccordion.prototype.componentWillLoad = function () {
        this.setupAccordions();
    };
    GxgAccordion.prototype.setupAccordions = function () {
        var _this = this;
        ...
        if (this.singleItemOpen) {
            ...
            var numberOfOpenAccordions_1 = 0;
            this.accordions.forEach(function (accordion) {
                if (accordion.getAttribute("status") ===
                    "open") {
                    numberOfOpenAccordions_1++;
                }
            });
            if (numberOfOpenAccordions_1 > 1) {
                var firstOpenAccordionFound_1 = false;
                this.accordions.forEach(function (accordion) {
                    if (accordion.getAttribute("status") === "open") {
                        if (firstOpenAccordionFound_1) {
                            accordion.setAttribute("status", "closed");
                        }
                        else {
                            firstOpenAccordionFound_1 = true;
                        }
                    }
                });
            }
        ...
        this.accordions.forEach(function (accordion) {
            accordion.setAttribute("mode", _this.mode);
            if (_this.noPadding) {
    ...
    GxgAccordion.prototype.render = function () {
        return (h(Host, { style: {
                "max-width": this.maxWidth,
            } }, h("slot", null)));
    };
    Object.defineProperty(GxgAccordion.prototype, "el", {
...
GxgAccordion.style = accordionCss;
export { GxgAccordion as gxg_accordion };
