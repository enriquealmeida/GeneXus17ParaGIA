...
var GxgTree = /** @class */ (function () {
    ...
    GxgTree.prototype.render = function () {
        ...
        return this.mainTree ? (h("div", { class: {
                tree: true,
                "main-tree": true,
            } }, h("div", { class: "main-tree-container" }, h("ul", { ref: function (el) { return (_this.ulTree = el); } }, h("slot", null))))) : (h("div", { class: {
                tree: true,
                "nested-tree": true,
            } }, h("ul", { ref: function (el) { return (_this.ulTree = el); } }, h("slot", null))));
    };
