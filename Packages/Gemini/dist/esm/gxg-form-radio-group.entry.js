...
import { r as requiredLabel, f as formMessage } from './common-d08cabb3.js';
...
const GxgFormRadioGroup = class {
    ...
    *********************************/
    ...
    labelFunc() {
        if (this.label) {
            return (h("span", { class: "label" }, this.label, requiredLabel(this)));
        }
    }
    render() {
        return (h(Host, null, this.labelFunc(), h("slot", null), formMessage(this.isRequiredError ? (h("gxg-form-message", { type: "error", key: "required-error" }, this.requiredMessage)) : null)));
    }
