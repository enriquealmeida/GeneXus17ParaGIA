...
const GxgFormRadio = class {
    ...
    *********************************/
    ...
    render() {
        return (h(Host, null, h("label", { class: "label" }, h("input", { ref: (el) => (this.radioInput = el), type: "radio", name: this.name, id: this.RadioId, value: this.value, onClick: this.selectRadio.bind(this), disabled: this.disabled, onKeyDown: this.handlerOnKeyDown.bind(this) }), h("span", { class: { radiobtn: true, "radiobtn--error": this.error } }), this.label)));
    }
