...
const GxgStepper = class {
    ...
    *********************************/
    ...
    render() {
        return (h(Host, { class: {
                rtl: this.rtl
            } }, h("label", { class: "label" }, this.label), h("div", { class: "outer-wrapper" }, h("button", { ref: el => (this.minusButton = el), class: "button button--minus", onClick: this.minus.bind(this), tabindex: "0" }, "-"), h("span", { class: "value-container" }, h("span", { class: "value-container__value" }, this.value)), h("button", { ref: el => (this.plusButton = el), class: "button button--plus", onClick: this.plus.bind(this), tabindex: "0" }, "+"))));
    }
