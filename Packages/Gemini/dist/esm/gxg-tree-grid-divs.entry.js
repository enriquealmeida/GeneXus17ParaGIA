...
const GxgTreeGridDivs = class {
    ...
    parseRows(row, level, i) {
        ...
        this.rowsBuffer.push(h("div", { class: { tr: true }, onClick: (e) => this.trClick(e, row), id: row.id }, Object.keys(row["cells"]).map((td, i) => (h("div", { class: { td: true }, style: {
            ...
            }, "data-value-type": td }, hasChildren && i === 0 ? (h("div", { class: { "icon-text-container": true } }, this.arrowIcon(i, hasChildren, row), 
        //row["cells"][td]
    ...
    render() {
        return (h(Host, null, h("div", { class: { table: true }, style: { width: this.width } }, h("div", { class: { tr: true } }, this.columns.map((th) => {
