...
const GxgWindow = class {
    ...
    render() {
        return (h(Host, { class: {
                ...
                minHeight: this.minHeight,
                maxHeight: this.maxHeight,
            } }, h("div", { id: "header", style: { cursor: "grab" }, ref: (el) => (this.header = el) }, h("div", { class: { "title-container": true } }, this.titleIcon !== "" ? (h("gxg-icon", { class: "title-icon", color: "auto", size: "regular", type: this.titleIcon })) : null, this.windowTitle !== "" ? this.windowTitle : null), h("gxg-button", { class: { "delete-icon": true }, icon: "menus/delete", type: "tertiary", onClick: () => this.closeWindow() })), h("div", { id: "content" }, h("slot", null))))));
    }
