...
function QueryViewer() {
	...
	this.realShow = function () {
		...
		this.calculateRealOutputType((function () {
			...
			gx.http.loadScripts(this.getScripts(), tryToRenderControl);
		}).closure(this));
	...
	this.getScripts = function() {
		...
		switch (this.RealType) {
			case QueryViewerOutputType.PivotTable:
			case QueryViewerOutputType.Table:
				scripts.push(staticDir + "QueryViewer/oatPivot/gxpivotjs.js");
				break;
			case QueryViewerOutputType.Chart:
				scripts.push(staticDir + "QueryViewer/highcharts/highcharts.js");
				scripts.push(staticDir + "QueryViewer/highcharts/highcharts-3d.js");
				scripts.push(staticDir + "QueryViewer/highcharts/highcharts-more.js");
				scripts.push(staticDir + "QueryViewer/highcharts/modules/funnel.js");
				scripts.push(staticDir + "QueryViewer/highcharts/modules/solid-gauge.js");
				break;
			case QueryViewerOutputType.Map:
				scripts.push(staticDir + "QueryViewer/Echarts/dist/echarts.min.js");
