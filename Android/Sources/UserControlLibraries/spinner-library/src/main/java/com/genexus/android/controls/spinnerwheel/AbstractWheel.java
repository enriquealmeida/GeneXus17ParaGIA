...
package com.genexus.android.controls.spinnerwheel;
...
public abstract class AbstractWheel extends View {
    ...
    // Listeners
    private List<OnWheelChangedListener> changingListeners = new ArrayList<>();
    private List<OnWheelScrollListener> scrollingListeners = new ArrayList<>();
    private List<OnWheelClickedListener> clickingListeners = new ArrayList<>();
     ...
     * @param isAllVisible set isAllVisible
     */
