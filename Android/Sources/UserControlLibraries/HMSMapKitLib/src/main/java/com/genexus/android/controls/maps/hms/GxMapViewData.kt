...
internal class GxMapViewData(mapDefinition: GxMapViewDefinition?, itemsData: ViewData?) : MapDataBase<GxMapViewItem, MapLocation, MapLocationBounds>(itemsData, MapUtils(mapDefinition)) {
