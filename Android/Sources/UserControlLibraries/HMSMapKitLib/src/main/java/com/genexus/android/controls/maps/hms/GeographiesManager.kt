...
import com.genexus.android.controls.maps.hms.HuaweiMapsHelper.applyClassToPolygonOptions
import com.genexus.android.controls.maps.hms.HuaweiMapsHelper.applyClassToPolylineOptions
import com.genexus.android.controls.maps.hms.MapLocation.Companion.listToLatLng
import com.genexus.android.controls.maps.hms.MapLocation.Companion.toLatLngLists
...
internal class GeographiesManager(
    ...
    BitmapDescriptor, HuaweiMap.OnMarkerDragListener>(mapView, definition) {

    override fun setMarkerDragListener(dragListener: HuaweiMap.OnMarkerDragListener) {
        huaweiMap.setOnMarkerDragListener(dragListener)
    }
    ...
    override fun addMarker(id: String, mapLocation: IMapLocation, draggable: Boolean, iconData: MapPinHelper.ResourceOrBitmap?): Marker {
        ...
        val marker = huaweiMap.addMarker(options)
    ...
    override fun addPolygon(
        ...
        val polygon = huaweiMap.addPolygon(options)
    ...
    override fun buildPolygonOptions(
        ...
        if (strokeColor == null && polygonColor == null && strokeWidth == null && defaultPolygonClass != null) {
            ...
            strokeColor?.let { polygonOptions.fillColor(it) }
    ...
    init {
        huaweiMap.setOnMarkerClickListener { marker: Marker -> clickedListener!!.geographyClicked(getFeature(getFeatureKey(marker))) }
        huaweiMap.setOnPolylineClickListener { line: Polyline -> clickedListener!!.geographyClicked(getFeature(getFeatureKey(line))) }
        huaweiMap.setOnPolygonClickListener { polygon: Polygon -> clickedListener!!.geographyClicked(getFeature(getFeatureKey(polygon))) }
    }
}
