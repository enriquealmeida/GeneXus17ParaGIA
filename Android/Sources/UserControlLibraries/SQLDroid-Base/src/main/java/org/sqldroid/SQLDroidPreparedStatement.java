...
public class SQLDroidPreparedStatement implements PreparedStatement {
  ...
  public SQLDroidPreparedStatement(String sql, SQLDroidConnection sqldroid) {
    Log.i("new SqlDRoid prepared statement from " + sqldroid /*+ " sql " + sql */);
    Log.d("new SqlDRoid prepared statement from " + sqldroid + " sql " + sql );
  ...
  private String[] makeArgListQueryString() {
    ...
    for(Object o : l) {
        ...
        {
            Log.w("makeArgListString with null value.");
            strList.add("null"); // insert null value to select parameters collection
        }
    }

	Log.d("makeArgListQueryString " + strList.toString());

	return strList.toArray(new String [1]);
  }
  private Object[] makeArgListQueryObject()
  {
	Log.d("makeArgListQueryObject " + l.toString());
    return l.toArray();
  }
  ...
  public int executeUpdate() throws SQLException {
    // return the count the actual number of updates .... :S
    execute();
    return updateCount;
  }
  ...
  throws SQLException {
    ...
    setObj(parameterIndex, theBigDecimal.toString());
