...
public class SQLiteDatabase {
  ...
  public SQLiteDatabase(String dbQname, long timeout) throws SQLException {
    ...
    do {
      try {
		  sqliteDatabase = net.sqlcipher.database.SQLiteDatabase.openDatabase(dbQname, SQLDroidHelper.getSQLDroidData(), null, net.sqlcipher.database.SQLiteDatabase.CREATE_IF_NECESSARY | net.sqlcipher.database.SQLiteDatabase.OPEN_READWRITE);
		  //sqliteDatabase = net.sqlcipher.database.SQLiteDatabase.openDatabase(dbQname, "mini", null, net.sqlcipher.database.SQLiteDatabase.CREATE_IF_NECESSARY | net.sqlcipher.database.SQLiteDatabase.OPEN_READWRITE);
